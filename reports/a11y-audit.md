# Accessibility audit — 2026-08-15

Target: `http://localhost:4499` · 22 pages · axe-core WCAG 2.1 A/AA
...
| --- | --- | ---: | ---: | --- |
| serious | `color-contrast` | 12 | 1 | Elements must meet minimum color contrast ratio thresholds |
...
- **serious** `color-contrast` (12 elements) — Elements must meet minimum color contrast ratio thresholds
  - e.g. `<span class="ewl-preset-btn">Launch Preset ↗</span>`
