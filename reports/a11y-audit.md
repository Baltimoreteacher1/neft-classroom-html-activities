# Accessibility audit — 2026-08-09

Target: `http://127.0.0.1:4501` · 21 pages · axe-core WCAG 2.1 A/AA
...
| Curriculum hub | 98 | custom (UA ring replaced) | 0 |
| Activity directory | 252 | custom | 0 |
...
| Lesson Learn It | 44 | custom (UA ring replaced) | 0 |
| Lesson vocabulary | 36 | custom (UA ring replaced) | 0 |
| Lesson homework | 49 | custom (UA ring replaced) | 0 |
