...
const CSS_BLOCK = `\n${BEGIN_MARK}\n    <link rel="stylesheet" href="/assets/learning-supports/learning-supports.css?v=20260713-supports-v22" />\n${END_MARK}`;
const JS_BLOCK = `\n${BEGIN_MARK}\n    <script src="/assets/learning-supports/learning-supports.js?v=20260713-supports-v22" defer></script>\n${END_MARK}`;
...
function injectFile(file, lessonId) {
  ...
  if (!html.includes("learning-supports.css?v=20260713-supports-v22")) {
  ...
  if (!html.includes("learning-supports.js?v=20260713-supports-v22")) {
...
function checkFile(file, lessonId) {
  ...
  const hasCss = html.includes("/assets/learning-supports/learning-supports.css?v=20260713-supports-v22");
  const hasJs = html.includes("/assets/learning-supports/learning-supports.js?v=20260713-supports-v22");
