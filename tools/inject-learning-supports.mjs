...
const CSS_BLOCK = `\n${BEGIN_MARK}\n    <link rel="stylesheet" href="/assets/learning-supports/learning-supports.css?v=20260714-supports-v24" />\n${END_MARK}`;
const JS_BLOCK = `\n${BEGIN_MARK}\n    <script src="/assets/learning-supports/learning-supports.js?v=20260714-supports-v24" defer></script>\n${END_MARK}`;
...
function injectFile(file, lessonId) {
  ...
  if (!html.includes("learning-supports.css?v=20260714-supports-v24")) {
  ...
  if (!html.includes("learning-supports.js?v=20260714-supports-v24")) {
...
function checkFile(file, lessonId) {
  ...
  const hasCss = html.includes("/assets/learning-supports/learning-supports.css?v=20260714-supports-v24");
  const hasJs = html.includes("/assets/learning-supports/learning-supports.js?v=20260714-supports-v24");
