...
const CSS_BLOCK = `\n${BEGIN_MARK}\n    <link rel="stylesheet" href="/assets/learning-supports/learning-supports.css?v=20260713-supports-v23" />\n${END_MARK}`;
const JS_BLOCK = `\n${BEGIN_MARK}\n    <script src="/assets/learning-supports/learning-supports.js?v=20260713-supports-v23" defer></script>\n${END_MARK}`;
...
function injectFile(file, lessonId) {
  ...
  if (!html.includes("learning-supports.css?v=20260713-supports-v23")) {
  ...
  if (!html.includes("learning-supports.js?v=20260713-supports-v23")) {
...
function checkFile(file, lessonId) {
  ...
  const hasCss = html.includes("/assets/learning-supports/learning-supports.css?v=20260713-supports-v23");
  const hasJs = html.includes("/assets/learning-supports/learning-supports.js?v=20260713-supports-v23");
