...
//   - worksheet-answer-key.html → teacher print keys (gated by isTeacherSurface
//     via the answer-key substring; no student work to save)
export const SKIP_FILE_RE =
  /(^|[/\\])(404|sitemap|robots)\b|(^|[/\\])(printable|worksheet-answer-key)\.html$/i;
