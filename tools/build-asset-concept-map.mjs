...
//
// (Misconception-level tags are deliberately NOT modeled here: no authored
// source exists yet. When one does, add it as a real feature with its own
// source file + Resource Finder UI — not an empty slot nothing reads.)
// =============================================================================
...
const out = {
  ...
  note: "GENERATED by tools/build-asset-concept-map.mjs — do not hand-edit. Inverse index: standard -> assets that teach it, across all catalog categories. `via`: direct (asset config) | manual (overrides file) | unit (project inherits unit standards).",
  source: {
