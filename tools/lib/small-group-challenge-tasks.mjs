  ...
  "9-1-group2": {
    ...
    add: [
      ...
      },
      {
        ...
        choiceFeedbackEs: [
          "",
          "Encuentra un caso donde el valor dependiente sea más pequeño — 90 minutos de trote, 9 millas corridas — y la afirmación se rompe.",
          "Ese es el mismo error al revés. Intenta encontrar un caso donde el valor dependiente sea más grande.",
          "Las unidades tampoco deciden los papeles. 90 minutos → 9 millas usa unidades distintas y el valor dependiente sigue siendo más pequeño.",
        ],
        hints: [
