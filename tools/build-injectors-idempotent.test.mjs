...
/** Exactly the injectors `npm run build` invokes, in build order. */
const INJECTORS = [
...
console.log("build injectors are no-ops on committed source");
...
console.log(`   ✓ all ${INJECTORS.length} build injectors left the working tree unchanged`);
