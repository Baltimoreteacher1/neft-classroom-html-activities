...
const WEB_APP_URL =
  "https://script.google.com/macros/s/AKfycbyOeIR6HcP_DxYgQRT9IbiWojIVPleXAhdKhwucpg1f5sqHovlQ1ea08XrhPvOamkuKVw/exec";
...
async function generateSlidesForLesson(id) {
  ...
  if (
    ...
    throw new Error(
      "Authorization Required! Please open the Apps Script project and run selfTest once to authorize scopes.",
    );
  }
