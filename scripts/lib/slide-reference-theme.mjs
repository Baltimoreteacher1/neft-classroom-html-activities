...
export const REFERENCE_CSS = `
    ...
    /* Authored Be Curious artwork. Bounded so a tall photo cannot push the
       notice/wonder panels off a projected slide. */
    .nw-figure { margin: 8px 0 0; text-align: center; }
    .nw-figure img {
      max-width: 100%;
      max-height: 220px;
      width: auto;
    ...
    /* Summarize — Key Concept recap (Reveal's second-to-last teaching beat) */
    .sum-keyidea {
      font-size: 13px;
      line-height: 1.5;
      font-weight: 600;
