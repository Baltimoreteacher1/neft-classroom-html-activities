...
export const META = {
  ...
  tagline:
    "Diagnose the gap, close it with TPT-quality practice, games, worked examples, and worksheets, then prove growth with a post-quiz.",
};
...
export const TOPICS = [
  {
    ...
    skills: ["Multiply", "Divide", "Estimate", "Order of operations"],
    lessons: 4,
    objective:
    ...
    bank: [
      ...
      },
      {
        ...
        answer: "1,728",
        options: ["1,728", "1,628", "1,748", "84"],
        distractors: ["1,628", "1,748", "84"],
      ...
      },
      {
        ...
        answer: "123",
        options: ["123", "122", "133", "123 R2"],
        distractors: ["122", "133", "123 R2"],
        explain: "6 × 123 = 738 exactly, so there is no remainder.",
      },
      {
        prompt: "A box holds 24 crayons. How many crayons are in 15 boxes?",
        answer: "360",
        options: ["360", "350", "390", "39"],
        distractors: ["350", "390", "39"],
        explain: "24 × 15 = 360 crayons in all.",
      },
      {
        prompt: "A baker has 156 muffins packed 12 to a tray. How many full trays?",
        answer: "13",
        options: ["13", "12", "14", "144"],
        distractors: ["12", "14", "144"],
        explain: "156 ÷ 12 = 13 trays with no muffins left over.",
      },
      {
        prompt:
          "Tickets cost $8 each. Maria buys 45 tickets and pays a $30 fee. What is the total cost?",
        answer: "$390",
        options: ["$390", "$360", "$83", "$330"],
        distractors: ["$360", "$83", "$330"],
        explain: "8 × 45 = 360, then add the $30 fee to get $390.",
      },
      {
        prompt:
          "A school orders 500 pencils packed 7 to a pouch. How many full pouches, and how many pencils are left over?",
        ...
        distractors: ["70 pouches, 3 left", "71 pouches, 4 left", "72 pouches, 1 left"],
        explain: "7 × 71 = 497, and 500 − 497 = 3 left over.",
      },
      {
        prompt:
          "Estimate the cost of 28 shirts that sell for $412 each by rounding to the nearest ten and hundred.",
        answer: "$12,000",
        options: ["$12,000", "$8,000", "$1,200", "$11,536"],
        distractors: ["$8,000", "$1,200", "$11,536"],
      ...
      },
      {
        ...
        answer: "864",
        options: ["864", "854", "60", "884"],
        distractors: ["854", "60", "884"],
        explain: "36 × 24 = 864 books read in total.",
      },
      {
        prompt:
          "A field trip has 720 students riding buses that hold 15 each. How many buses are needed?",
        answer: "48",
        options: ["48", "47", "49", "705"],
        distractors: ["47", "49", "705"],
      ...
      {
        prompt:
          "A store splits 1,456 stickers equally into 12 prize bags. How many per bag, and how many are left over?",
        ...
        distractors: ["120 per bag, 4 left", "121 per bag, 6 left", "122 per bag, 2 left"],
    ...
    preQuiz: [
      {
        prompt: "What is 38 × 7?",
        answer: "266",
        options: ["266", "256", "276", "45"],
        distractors: ["256", "276", "45"],
        explain: "7 × 30 = 210 and 7 × 8 = 56, so 210 + 56 = 266.",
      },
      {
        prompt: "What is 56 × 89?",
        answer: "4,984",
        options: ["4,984", "4,884", "4,994", "145"],
        distractors: ["4,884", "4,994", "145"],
        explain: "56 × 89 = 56 × 80 + 56 × 9 = 4,480 + 504 = 4,984.",
      },
      {
        prompt: "What is 365 ÷ 12 written with a remainder?",
        answer: "30 R5",
        options: ["30 R5", "30 R4", "31 R5", "30"],
        distractors: ["30 R4", "31 R5", "30"],
        explain: "12 × 30 = 360, and 365 − 360 = 5.",
      },
      {
        prompt: "What is 584 ÷ 9 written with a remainder?",
        answer: "64 R8",
        options: ["64 R8", "64 R7", "65 R8", "64"],
        distractors: ["64 R7", "65 R8", "64"],
        explain: "9 × 64 = 576, and 584 − 576 = 8.",
      },
      {
        prompt: "Estimate 39 × 21 by rounding each number to the nearest ten.",
        answer: "800",
        options: ["800", "600", "819", "1,000"],
        distractors: ["600", "819", "1,000"],
        explain: "39 rounds to 40 and 21 rounds to 20, and 40 × 20 = 800.",
      },
      {
      ...
      },
      {
        ...
        answer: "19",
        options: ["19", "28", "13", "17"],
        distractors: ["28", "13", "17"],
        explain: "Divide and multiply first: 9 + 10 = 19.",
      },
      {
        prompt:
          "A store splits 2,476 marbles equally into 8 jars. How many per jar, and how many are left over?",
        ...
        distractors: ["309 per jar, 2 left", "308 per jar, 4 left", "310 per jar, 4 left"],
    ...
    postQuiz: [
      {
        prompt: "What is 47 × 6?",
        answer: "282",
        options: ["282", "272", "288", "53"],
        distractors: ["272", "288", "53"],
        explain: "6 × 40 = 240 and 6 × 7 = 42, so 240 + 42 = 282.",
      },
      {
        prompt: "What is 72 × 48?",
        answer: "3,456",
        options: ["3,456", "3,356", "3,476", "120"],
        distractors: ["3,356", "3,476", "120"],
        explain: "72 × 48 = 72 × 40 + 72 × 8 = 2,880 + 576 = 3,456.",
      },
      {
        prompt: "What is 738 ÷ 6?",
        answer: "123",
        options: ["123", "122", "133", "123 R1"],
        distractors: ["122", "133", "123 R1"],
        explain: "6 × 123 = 738 exactly, so there is no remainder.",
      },
      {
        prompt: "What is 925 ÷ 4 written with a remainder?",
        answer: "231 R1",
        options: ["231 R1", "230 R1", "231 R2", "231"],
        distractors: ["230 R1", "231 R2", "231"],
        explain: "4 × 231 = 924, and 925 − 924 = 1.",
      },
      {
        prompt: "Estimate 58 × 31 by rounding each number to the nearest ten.",
        answer: "1,800",
        options: ["1,800", "1,500", "1,798", "2,100"],
        distractors: ["1,500", "1,798", "2,100"],
      ...
      },
      {
        ...
        answer: "125",
        options: ["125", "124", "126", "1,488"],
        distractors: ["124", "126", "1,488"],
  ...
  },
  {
    ...
    skills: ["GCF & LCM", "Primes", "Factor trees", "Distributive"],
    lessons: 4,
    objective:
    ...
    bank: [
      {
        ...
        answer: "1, 2, 3, 4, 6, 12",
        options: ["1, 2, 3, 4, 6, 12", "1, 2, 3, 4, 12", "2, 3, 4, 6", "1, 2, 6, 12"],
        distractors: ["1, 2, 3, 4, 12", "2, 3, 4, 6", "1, 2, 6, 12"],
        explain:
          "The factors of 12 are all whole numbers that divide 12 evenly: 1, 2, 3, 4, 6, 12.",
      },
      {
        prompt: "Which number is a multiple of 5?",
        answer: "35",
        options: ["35", "52", "24", "41"],
        distractors: ["52", "24", "41"],
      ...
      },
      {
        ...
        distractors: ["Composite", "Neither", "Both"],
      ...
      },
      {
        ...
        distractors: ["Prime", "Neither", "Both"],
      ...
      },
      {
        ...
        distractors: ["2 × 9", "3 × 6", "2 × 2 × 3"],
        explain: "18 = 2 × 9 = 2 × 3 × 3, all prime factors.",
      },
      {
        prompt: "What is the prime factorization of 24?",
        answer: "2 × 2 × 2 × 3",
        options: ["2 × 2 × 2 × 3", "2 × 2 × 3", "4 × 6", "2 × 3 × 4"],
        distractors: ["2 × 2 × 3", "4 × 6", "2 × 3 × 4"],
      ...
      },
      {
        ...
        answer: "2 × 2 × 3 × 3",
        options: ["2 × 2 × 3 × 3", "2 × 2 × 9", "6 × 6", "2 × 3 × 6"],
        distractors: ["2 × 2 × 9", "6 × 6", "2 × 3 × 6"],
      ...
      },
      {
        ...
        answer: "6 × (2 + 3)",
        options: ["6 × (2 + 3)", "6 × (2 + 6)", "3 × (4 + 6)", "6 × (12 + 18)"],
        distractors: ["6 × (2 + 6)", "3 × (4 + 6)", "6 × (12 + 18)"],
      ...
      },
      {
        ...
        answer: "8 × (2 + 3)",
        options: ["8 × (2 + 3)", "8 × (2 + 4)", "4 × (4 + 6)", "8 × (16 + 24)"],
        distractors: ["8 × (2 + 4)", "4 × (4 + 6)", "8 × (16 + 24)"],
        explain: "The GCF is 8; 16 = 8×2 and 24 = 8×3, so 8 × (2 + 3).",
      },
      {
        prompt:
          "A baker has 24 muffins and 36 cookies. She wants the largest equal-size gift boxes using all the treats, with each box having only muffins or only cookies. How many boxes can she make?",
        answer: "12",
        options: ["12", "6", "2", "60"],
        distractors: ["6", "2", "60"],
      ...
      {
        prompt:
          "Hot dogs come in packs of 10 and buns come in packs of 8. What is the least number of each Maria must buy to have an equal number with none left over?",
        answer: "40",
        options: ["40", "80", "18", "20"],
        distractors: ["80", "18", "20"],
        explain: "The LCM of 10 and 8 is 40, the smallest number both pack sizes reach.",
      },
      {
        prompt:
          "Two friends jog around a track. One finishes a lap every 6 minutes, the other every 9 minutes. After how many minutes will they both be at the start together again?",
        answer: "18",
        options: ["18", "54", "3", "15"],
        distractors: ["54", "3", "15"],
      ...
      {
        prompt:
          "A teacher has 30 pencils and 45 erasers to split into identical kits with no leftovers. What is the greatest number of kits she can make?",
        answer: "15",
        options: ["15", "5", "3", "90"],
        distractors: ["5", "3", "90"],
      ...
      {
        prompt:
          "A lighthouse blinks every 12 seconds and a buoy blinks every 18 seconds. They blink together now. How many seconds until they next blink together?",
        answer: "36",
        options: ["36", "72", "6", "30"],
        distractors: ["72", "6", "30"],
      ...
      {
        prompt:
          "A florist has 42 roses and 56 tulips. She makes identical bouquets using all flowers with the greatest number of bouquets possible. How many roses are in each bouquet?",
        answer: "3",
        options: ["3", "14", "4", "6"],
        distractors: ["14", "4", "6"],
    ...
    preQuiz: [
      {
        ...
        answer: "1, 2, 5, 10",
        options: ["1, 2, 5, 10", "1, 2, 10", "2, 5", "1, 5, 10"],
        distractors: ["1, 2, 10", "2, 5", "1, 5, 10"],
      ...
      },
      {
        ...
        answer: "2 × 2 × 3",
        options: ["2 × 2 × 3", "2 × 6", "3 × 4", "2 × 2 × 2"],
        distractors: ["2 × 6", "3 × 4", "2 × 2 × 2"],
      ...
      {
        prompt:
          "Tennis balls come in cans of 4 and players come in groups of 6. What is the least number you need to have an equal number with none left over?",
        answer: "12",
        options: ["12", "24", "10", "2"],
        distractors: ["24", "10", "2"],
    ...
    postQuiz: [
      {
        ...
        answer: "1, 2, 4, 8, 16",
        options: ["1, 2, 4, 8, 16", "1, 2, 4, 16", "2, 4, 8", "1, 4, 8, 16"],
        distractors: ["1, 2, 4, 16", "2, 4, 8", "1, 4, 8, 16"],
      ...
      },
      {
        ...
        answer: "2 × 2 × 2 × 5",
        options: ["2 × 2 × 2 × 5", "2 × 2 × 5", "4 × 10", "2 × 4 × 5"],
        distractors: ["2 × 2 × 5", "4 × 10", "2 × 4 × 5"],
        explain: "40 = 2 × 2 × 2 × 5, all prime factors.",
      },
      {
        prompt: "Using the distributive property, 15 + 20 can be written as which expression?",
        answer: "5 × (3 + 4)",
        options: ["5 × (3 + 4)", "5 × (3 + 5)", "3 × (5 + 7)", "5 × (15 + 20)"],
        distractors: ["5 × (3 + 5)", "3 × (5 + 7)", "5 × (15 + 20)"],
        explain: "The GCF is 5; 15 = 5×3 and 20 = 5×4, so 5 × (3 + 4).",
      },
      {
        prompt:
          "Pencils come in boxes of 9 and erasers in boxes of 12. What is the least number of each you must buy to have an equal amount with none left over?",
        answer: "36",
        options: ["36", "72", "21", "108"],
        distractors: ["72", "21", "108"],
  ...
  },
  {
    ...
    lessons: 4,
    objective:
      "I can find equivalent fractions, write fractions in simplest form, compare fractions, add and subtract fractions with unlike denominators, and multiply and divide fractions.",
    estMin: 30,
    vocab: [
      {
        term: "Numerator",
    ...
    bank: [
      ...
      },
      {
        ...
        distractors: ["2/1", "2/12", "1/12"],
        explain: "Rename to twelfths: 9/12 - 4/12 = 5/12.",
      },
      {
        prompt: "What is 4/5 x 10?",
        answer: "8",
        options: ["8", "40/5", "4/50", "14/5"],
        distractors: ["40/5", "4/50", "14/5"],
      ...
      },
      {
        ...
        answer: "2",
        options: ["2", "1/8", "1/2", "8"],
        distractors: ["1/8", "1/2", "8"],
        explain: "Multiply by the reciprocal: 1/2 x 4/1 = 4/2 = 2.",
      },
      {
        prompt: "What is 3/8 ÷ 1/2?",
        answer: "3/4",
        options: ["3/4", "3/16", "6/8", "4/3"],
        distractors: ["3/16", "6/8", "4/3"],
        explain: "3/8 x 2/1 = 6/8, which simplifies to 3/4.",
      },
      {
        prompt:
          "A recipe needs 2/3 cup of sugar. You make half the recipe. How much sugar do you need?",
        answer: "1/3 cup",
        options: ["1/3 cup", "1/6 cup", "2/6 cup", "4/3 cup"],
        distractors: ["1/6 cup", "2/6 cup", "4/3 cup"],
      ...
      },
      {
        ...
        answer: "1/8 mile",
        options: ["1/8 mile", "2/4 mile", "2/8 mile", "1/4 mile"],
        distractors: ["2/4 mile", "2/8 mile", "1/4 mile"],
      ...
      },
      {
        ...
        answer: "2 slices",
        options: ["2 slices", "4 slices", "1 slice", "3 slices"],
        distractors: ["4 slices", "1 slice", "3 slices"],
        explain: "1/4 of 8 is 1/4 x 8 = 8/4 = 2 slices.",
      },
      {
        prompt:
          "You have 3/4 of a yard of ribbon and cut it into pieces 1/8 yard long. How many pieces do you get?",
        answer: "6 pieces",
        options: ["6 pieces", "3 pieces", "4 pieces", "8 pieces"],
        distractors: ["3 pieces", "4 pieces", "8 pieces"],
        explain: "3/4 ÷ 1/8 = 3/4 x 8/1 = 24/4 = 6 pieces.",
      },
      {
        prompt:
          "A water tank is 5/6 full. After use it is 1/3 full. What fraction of the tank was used?",
        answer: "1/2",
        options: ["1/2", "4/3", "2/3", "4/6"],
        distractors: ["4/3", "2/3", "4/6"],
        explain: "Rename 1/3 as 2/6, then 5/6 - 2/6 = 3/6 = 1/2.",
      },
      {
        prompt:
          "A board is 2 1/2 feet long. You need pieces that are 1/2 foot each. How many pieces can you cut?",
        answer: "5 pieces",
        options: ["5 pieces", "2 pieces", "4 pieces", "10 pieces"],
        distractors: ["2 pieces", "4 pieces", "10 pieces"],
    ...
    preQuiz: [
      {
        ...
        answer: "2/6",
        options: ["2/6", "1/6", "2/3", "3/6"],
        distractors: ["1/6", "2/3", "3/6"],
        explain: "Multiply 1/3 top and bottom by 2 to get 2/6.",
      },
      {
        prompt: "Write 6/9 in simplest form.",
        answer: "2/3",
        options: ["2/3", "3/9", "6/9", "1/3"],
        distractors: ["3/9", "6/9", "1/3"],
      ...
      },
      {
        ...
        answer: "1/2",
        options: ["1/2", "4/16", "3/8", "4/8 only"],
        distractors: ["4/16", "3/8", "4/8 only"],
        explain: "1/8 + 3/8 = 4/8, which simplifies to 1/2.",
      },
      {
        prompt: "What is 2/3 - 1/6?",
        answer: "1/2",
        options: ["1/2", "1/3", "3/6 wrong reduce", "1/6"],
        distractors: ["1/3", "3/6 wrong reduce", "1/6"],
        explain: "Rename 2/3 as 4/6, then 4/6 - 1/6 = 3/6 = 1/2.",
      },
      {
        prompt: "What is 3/5 x 2/3?",
        answer: "2/5",
        options: ["2/5", "5/8", "6/8", "2/3"],
        distractors: ["5/8", "6/8", "2/3"],
        explain: "3/5 x 2/3 = 6/15, which simplifies to 2/5.",
      },
      {
        prompt: "What is 1/2 ÷ 1/6?",
        answer: "3",
        options: ["3", "1/12", "1/3", "6"],
        distractors: ["1/12", "1/3", "6"],
      ...
      },
      {
        ...
        answer: "3/8 cup",
        options: ["3/8 cup", "3/2 cup", "1/4 cup", "6/4 cup"],
        distractors: ["3/2 cup", "1/4 cup", "6/4 cup"],
    ...
    postQuiz: [
      {
        ...
        answer: "2/8",
        options: ["2/8", "1/8", "2/4", "3/8"],
        distractors: ["1/8", "2/4", "3/8"],
        explain: "Multiply 1/4 top and bottom by 2 to get 2/8.",
      },
      {
        prompt: "Write 8/12 in simplest form.",
        answer: "2/3",
        options: ["2/3", "4/12", "8/12", "1/3"],
        distractors: ["4/12", "8/12", "1/3"],
  ...
  },
  {
    ...
    skills: ["Place value", "Compare & round", "Operate", "Money"],
    lessons: 4,
    objective:
    ...
    bank: [
      {
        ...
        answer: "7 tenths",
        options: ["7 tenths", "7 ones", "7 hundredths", "7 thousandths"],
        distractors: ["7 ones", "7 hundredths", "7 thousandths"],
        explain: "The first digit after the decimal point is the tenths place.",
      },
      {
        prompt: "How do you read the decimal 0.6?",
        answer: "six tenths",
        options: ["six tenths", "six hundredths", "sixty", "six ones"],
        distractors: ["six hundredths", "sixty", "six ones"],
        explain: "One digit after the decimal point names the tenths place.",
      },
      {
        prompt: "Which decimal is the largest?",
        answer: "0.5",
        options: ["0.5", "0.45", "0.05", "0.49"],
        distractors: ["0.45", "0.05", "0.49"],
      ...
      },
      {
        ...
        answer: "5.5",
        options: ["5.5", "5.4", "5.0", "6.0"],
        distractors: ["5.4", "5.0", "6.0"],
    ...
    preQuiz: [
      {
        ...
        answer: "3 tenths",
        options: ["3 tenths", "3 hundredths", "3 ones", "3 thousandths"],
        distractors: ["3 hundredths", "3 ones", "3 thousandths"],
        explain: "The first place after the decimal point is tenths.",
      },
      {
        prompt: "Compare: which is greater, 0.4 or 0.38?",
        answer: "0.4",
        options: ["0.4", "0.38", "They are equal", "0.038"],
        distractors: ["0.38", "They are equal", "0.038"],
      ...
      },
      {
        ...
        answer: "8.05",
        options: ["8.05", "7.05", "8.5", "7.78"],
        distractors: ["7.05", "8.5", "7.78"],
        explain: "Line up decimals: 5.30 + 2.75 = 8.05.",
      },
      {
        prompt: "What is 10 - 4.6 ?",
        answer: "5.4",
        options: ["5.4", "6.4", "5.6", "4.4"],
        distractors: ["6.4", "5.6", "4.4"],
        explain: "Write 10 as 10.0, then subtract 4.6 to get 5.4.",
      },
      {
        prompt: "What is 3.2 x 0.5 ?",
        answer: "1.6",
        options: ["1.6", "16", "0.16", "1.5"],
        distractors: ["16", "0.16", "1.5"],
    ...
    postQuiz: [
      {
        ...
        answer: "9 tenths",
        options: ["9 tenths", "9 hundredths", "9 ones", "9 thousandths"],
        distractors: ["9 hundredths", "9 ones", "9 thousandths"],
        explain: "The first place after the decimal point is tenths.",
      },
      {
        prompt: "Compare: which is greater, 0.7 or 0.65?",
        answer: "0.7",
        options: ["0.7", "0.65", "They are equal", "0.065"],
        distractors: ["0.65", "They are equal", "0.065"],
      ...
      },
      {
        ...
        answer: "10.25",
        options: ["10.25", "9.25", "10.5", "9.89"],
        distractors: ["9.25", "10.5", "9.89"],
        explain: "Line up decimals: 6.40 + 3.85 = 10.25.",
      },
      {
        prompt: "What is 15 - 7.3 ?",
        answer: "7.7",
        options: ["7.7", "8.7", "7.3", "8.3"],
        distractors: ["8.7", "7.3", "8.3"],
        explain: "Write 15 as 15.0, then subtract 7.3 to get 7.7.",
      },
      {
        prompt: "What is 4.6 x 0.5 ?",
        answer: "2.3",
        options: ["2.3", "23", "0.23", "2.5"],
        distractors: ["23", "0.23", "2.5"],
  ...
  },
  {
    ...
    skills: ["Ratios", "Equivalent ratios", "Unit rate", "Better buy"],
    lessons: 4,
    objective:
    ...
    bank: [
      {
        prompt:
          "There are 5 red marbles and 3 blue marbles. What is the ratio of red to blue marbles?",
        answer: "5 to 3",
        options: ["5 to 3", "3 to 5", "5 to 8", "8 to 3"],
        distractors: ["3 to 5", "5 to 8", "8 to 3"],
        explain: "Red comes first, so it is 5 red to 3 blue.",
      },
      {
        prompt: "A class has 7 boys and 9 girls. What is the ratio of girls to boys?",
        answer: "9 to 7",
        options: ["9 to 7", "7 to 9", "9 to 16", "16 to 9"],
        distractors: ["7 to 9", "9 to 16", "16 to 9"],
        explain: "Girls come first, so it is 9 girls to 7 boys.",
      },
      {
        prompt: "Which words describe the ratio 4:5?",
        answer: "4 to 5",
        options: ["4 to 5", "4 plus 5", "4 times 5", "5 to 4"],
        distractors: ["4 plus 5", "4 times 5", "5 to 4"],
        explain: "The symbol : means 'to', so 4:5 reads '4 to 5'.",
      },
      {
        prompt: "There are 6 dogs and 6 cats. What is the ratio of dogs to cats?",
        answer: "6 to 6",
        options: ["6 to 6", "6 to 12", "0 to 6", "12 to 6"],
        distractors: ["6 to 12", "0 to 6", "12 to 6"],
      ...
      },
      {
        ...
        answer: "2 to 3",
        options: ["2 to 3", "4 to 6", "8 to 12", "3 to 2"],
        distractors: ["4 to 6", "8 to 12", "3 to 2"],
        explain: "Divide both by 4: 8 ÷ 4 = 2 and 12 ÷ 4 = 3.",
      },
      {
        prompt: "Simplify the ratio 10:15.",
        answer: "2:3",
        options: ["2:3", "5:3", "2:5", "3:2"],
        distractors: ["5:3", "2:5", "3:2"],
      ...
      },
      {
        ...
        answer: "3 to 12",
        options: ["3 to 12", "4 to 1", "2 to 6", "3 to 8"],
        distractors: ["4 to 1", "2 to 6", "3 to 8"],
      ...
      },
      {
        ...
        distractors: ["60 miles per hour", "120 miles per hour", "2 miles per hour"],
        explain: "Divide miles by hours: 60 ÷ 2 = 30 miles per hour.",
      },
      {
        prompt: "8 pencils cost $4. What is the cost for one pencil?",
        answer: "$0.50",
        options: ["$0.50", "$2.00", "$4.00", "$1.00"],
        distractors: ["$2.00", "$4.00", "$1.00"],
      ...
      },
      {
        ...
        distractors: ["4 pages per minute", "8 pages per minute", "20 pages per minute"],
      ...
      },
      {
        ...
        distractors: ["3:2", "6:3", "9:6"],
        explain: "Divide both by 3: 6 ÷ 3 = 2 and 9 ÷ 3 = 3.",
      },
      {
        prompt:
          "A snack mix uses 3 cups of nuts for every 2 cups of raisins. How many cups of raisins go with 9 cups of nuts?",
        answer: "6 cups",
        options: ["6 cups", "4 cups", "5 cups", "8 cups"],
        distractors: ["4 cups", "5 cups", "8 cups"],
      ...
      },
      {
        ...
        options: ["6 apples for $2.40", "4 apples for $2.00", "They are equal", "Cannot tell"],
        distractors: ["4 apples for $2.00", "They are equal", "Cannot tell"],
        explain: "$2.00 ÷ 4 = $0.50; $2.40 ÷ 6 = $0.40, which is lower.",
      },
      {
        prompt:
          "A faucet leaks 9 liters in 3 hours. How many liters leak in 7 hours at the same rate?",
        answer: "21 liters",
        options: ["21 liters", "18 liters", "27 liters", "12 liters"],
        distractors: ["18 liters", "27 liters", "12 liters"],
        explain: "Unit rate is 9 ÷ 3 = 3 liters per hour; 3 × 7 = 21.",
      },
      {
        prompt: "A 12-ounce bottle costs $1.80. What is the price per ounce?",
        answer: "$0.15",
        options: ["$0.15", "$0.18", "$0.12", "$1.50"],
        distractors: ["$0.18", "$0.12", "$1.50"],
        explain: "Divide cost by ounces: $1.80 ÷ 12 = $0.15 per ounce.",
      },
      {
        prompt:
          "Maria types 180 words in 5 minutes. How many words can she type in 8 minutes at the same rate?",
        answer: "288 words",
        options: ["288 words", "225 words", "240 words", "360 words"],
        distractors: ["225 words", "240 words", "360 words"],
        explain: "Unit rate is 180 ÷ 5 = 36 words per minute; 36 × 8 = 288.",
      },
      {
        prompt:
          "A recipe uses 2 cups sugar to 5 cups flour. To use 20 cups of flour, how much sugar is needed?",
        answer: "8 cups",
        options: ["8 cups", "10 cups", "4 cups", "17 cups"],
        distractors: ["10 cups", "4 cups", "17 cups"],
        explain: "20 flour is 5 × 4, so sugar = 2 × 4 = 8 cups.",
      },
      {
        prompt:
          "Brand A: 16 oz for $3.20. Brand B: 24 oz for $4.32. Which is the better buy per ounce?",
      ...
      {
        prompt:
          "Two trains travel at steady speeds. Train X goes 150 miles in 3 hours; Train Y goes 280 miles in 4 hours. Which is faster?",
        ...
        distractors: ["Train X (50 mph)", "They are the same speed", "Train X (70 mph)"],
        explain: "X: 150 ÷ 3 = 50 mph; Y: 280 ÷ 4 = 70 mph, which is faster.",
      },
      {
        prompt:
          "A paint mix needs blue and yellow in a 3:4 ratio. To make 28 cups of mix, how many cups are yellow?",
        answer: "16 cups",
        options: ["16 cups", "12 cups", "14 cups", "21 cups"],
        distractors: ["12 cups", "14 cups", "21 cups"],
        explain: "Parts total 3 + 4 = 7; 28 ÷ 7 = 4 per part, so yellow = 4 × 4 = 16.",
      },
      {
        prompt:
          "A 5-pound bag of rice costs $6.25, and a 8-pound bag costs $9.60. How much money is saved per pound by buying the cheaper unit price?",
        answer: "$0.05 per pound",
        options: ["$0.05 per pound", "$0.10 per pound", "$0.25 per pound", "$0.15 per pound"],
        distractors: ["$0.10 per pound", "$0.25 per pound", "$0.15 per pound"],
    ...
    preQuiz: [
      {
        ...
        answer: "4 to 7",
        options: ["4 to 7", "7 to 4", "4 to 11", "11 to 4"],
        distractors: ["7 to 4", "4 to 11", "11 to 4"],
        explain: "Cats come first, so it is 4 cats to 7 dogs.",
      },
      {
        prompt: "Simplify the ratio 6 to 9.",
        answer: "2 to 3",
        options: ["2 to 3", "3 to 2", "2 to 9", "6 to 3"],
        distractors: ["3 to 2", "2 to 9", "6 to 3"],
        explain: "Divide both by 3: 6 ÷ 3 = 2 and 9 ÷ 3 = 3.",
      },
      {
        prompt: "Which ratio is equivalent to 2:5?",
        answer: "6:15",
        options: ["6:15", "5:2", "4:8", "6:10"],
        distractors: ["5:2", "4:8", "6:10"],
      ...
      },
      {
        ...
        distractors: ["80 miles per hour", "160 miles per hour", "20 miles per hour"],
        explain: "Divide miles by hours: 80 ÷ 2 = 40 miles per hour.",
      },
      {
        prompt: "6 apples cost $3. What is the cost of one apple?",
        answer: "$0.50",
        options: ["$0.50", "$2.00", "$1.50", "$3.00"],
        distractors: ["$2.00", "$1.50", "$3.00"],
      ...
      },
      {
        ...
        answer: "12 cups",
        options: ["12 cups", "10 cups", "6 cups", "16 cups"],
        distractors: ["10 cups", "6 cups", "16 cups"],
      ...
      },
      {
        ...
        options: ["6 pens for $2.40", "4 pens for $2.00", "They are equal", "Cannot tell"],
        distractors: ["4 pens for $2.00", "They are equal", "Cannot tell"],
        explain: "$2.00 ÷ 4 = $0.50; $2.40 ÷ 6 = $0.40, which is lower.",
      },
    ],
    postQuiz: [
      {
        ...
        answer: "5 to 8",
        options: ["5 to 8", "8 to 5", "5 to 13", "13 to 5"],
        distractors: ["8 to 5", "5 to 13", "13 to 5"],
        explain: "Pens come first, so it is 5 pens to 8 markers.",
      },
      {
        prompt: "Simplify the ratio 8 to 12.",
        answer: "2 to 3",
        options: ["2 to 3", "3 to 2", "2 to 12", "4 to 3"],
        distractors: ["3 to 2", "2 to 12", "4 to 3"],
        explain: "Divide both by 4: 8 ÷ 4 = 2 and 12 ÷ 4 = 3.",
      },
      {
        prompt: "Which ratio is equivalent to 3:4?",
        answer: "9:12",
        options: ["9:12", "4:3", "6:10", "9:16"],
        distractors: ["4:3", "6:10", "9:16"],
      ...
      },
      {
        ...
        distractors: ["90 miles per hour", "270 miles per hour", "3 miles per hour"],
      ...
      },
      {
        ...
        answer: "16 cups",
        options: ["16 cups", "14 cups", "8 cups", "20 cups"],
        distractors: ["14 cups", "8 cups", "20 cups"],
      ...
      },
      {
        ...
        distractors: ["5 juice boxes for $3.00", "They are equal", "Cannot tell"],
  ...
  },
  {
    ...
    skills: ["% of a number", "Conversions", "Find the whole", "Discounts"],
    lessons: 4,
    objective:
      "I can find the percent of a number, change between fractions, decimals, and percents, find the whole, and solve discount, tax, and tip problems.",
    estMin: 30,
    vocab: [
      {
        term: "Percent",
    ...
    bank: [
      ...
      },
      {
        ...
        answer: "$1.50",
        options: ["$1.50", "$6", "$2.50", "$15"],
        distractors: ["$6", "$2.50", "$15"],
      ...
      },
      {
        ...
        answer: "$62",
        options: ["$62", "$59", "$56", "$68"],
        distractors: ["$59", "$56", "$68"],
        explain: "18% is $9 tip and 6% is $3 tax, so 50 plus 9 plus 3 equals $62.",
      },
      {
        prompt:
          "A $40 shirt is 25% off, then 10% tax is added to the sale price. What is the final cost?",
        answer: "$33",
        options: ["$33", "$30", "$34.50", "$46"],
        distractors: ["$30", "$34.50", "$46"],
    ...
    postQuiz: [
      ...
      },
      {
        ...
        answer: "0.35",
        options: ["0.35", "3.5", "35", "0.035"],
        distractors: ["3.5", "35", "0.035"],
        explain: "Move the point two places left: 35% = 0.35.",
      },
      {
        prompt: "12 is 20% of what number?",
        answer: "60",
        options: ["60", "2.4", "40", "240"],
        distractors: ["2.4", "40", "240"],
  ...
  },
  {
    ...
    skills: ["Negatives", "Absolute value", "Opposites", "Add / subtract"],
    lessons: 4,
    objective:
    ...
    bank: [
      ...
      },
      {
        ...
        answer: "To the left",
        options: ["To the left", "To the right", "Above zero", "They are not on the line"],
        distractors: ["To the right", "Above zero", "They are not on the line"],
      ...
      },
      {
        ...
        answer: "-7, -3, 0, 2",
        options: ["-7, -3, 0, 2", "0, 2, -3, -7", "-3, -7, 0, 2", "2, 0, -3, -7"],
        distractors: ["0, 2, -3, -7", "-3, -7, 0, 2", "2, 0, -3, -7"],
      ...
      },
      {
        ...
        answer: "-13°F",
        options: ["-13°F", "3°F", "-3°F", "13°F"],
        distractors: ["3°F", "-3°F", "13°F"],
        explain: "Dropping means subtract: -5 - 8 = -13°F.",
      },
      {
        prompt: "A diver is at -150 feet. She rises 40 feet. What is her new depth?",
        answer: "-110 feet",
        options: ["-110 feet", "-190 feet", "110 feet", "-40 feet"],
        distractors: ["-190 feet", "110 feet", "-40 feet"],
      ...
      },
      {
        ...
        distractors: ["-$15", "-$105", "$105"],
        explain: "-45 + 60 = 15, so she now has $15.",
      },
      {
        prompt:
          "A submarine is 8 m below sea level, shown as -8. A bird is 13 m above where the submarine is. What is the bird's elevation?",
        answer: "5 m",
        options: ["5 m", "-5 m", "21 m", "-21 m"],
        distractors: ["-5 m", "21 m", "-21 m"],
        explain: "-8 + 13 = 5, so the bird is 5 m above sea level.",
      },
      {
        prompt: "Which list is ordered from coldest to warmest: -3°, -12°, -7° ?",
        answer: "-12°, -7°, -3°",
        options: ["-12°, -7°, -3°", "-3°, -7°, -12°", "-12°, -3°, -7°", "-7°, -12°, -3°"],
        distractors: ["-3°, -7°, -12°", "-12°, -3°, -7°", "-7°, -12°, -3°"],
        explain: "Coldest is the smallest number: -12°, then -7°, then -3°.",
      },
      {
        prompt:
          "In a game, Ravi loses 3 points then loses 6 more. His score change is -3 + (-6). What is it?",
        answer: "-9",
        options: ["-9", "-3", "9", "3"],
        distractors: ["-3", "9", "3"],
      ...
      },
      {
        ...
        answer: "-7 yards",
        options: ["-7 yards", "7 yards", "17 yards", "-17 yards"],
        distractors: ["7 yards", "17 yards", "-17 yards"],
        explain: "5 + (-12) = -7, a net loss of 7 yards.",
      },
      {
        prompt:
          "Death Valley is at -86 m and a nearby hill is at 14 m. How much higher is the hill than Death Valley?",
        answer: "100 m",
        options: ["100 m", "72 m", "-72 m", "-100 m"],
        distractors: ["72 m", "-72 m", "-100 m"],
        explain: "Distance is 14 - (-86) = 14 + 86 = 100 m.",
      },
      {
        prompt:
          "At dawn it was -4°C. By noon the temperature was 9°C. By how many degrees did it rise?",
        answer: "13 degrees",
        options: ["13 degrees", "5 degrees", "-13 degrees", "-5 degrees"],
        distractors: ["5 degrees", "-13 degrees", "-5 degrees"],
    ...
    preQuiz: [
      ...
      },
      {
        ...
        answer: "-6, -2, 0, 3",
        options: ["-6, -2, 0, 3", "0, -2, 3, -6", "-2, -6, 0, 3", "3, 0, -2, -6"],
        distractors: ["0, -2, 3, -6", "-2, -6, 0, 3", "3, 0, -2, -6"],
      ...
      },
      {
        ...
        answer: "-9°C",
        options: ["-9°C", "3°C", "-3°C", "9°C"],
        distractors: ["3°C", "-3°C", "9°C"],
    ...
    postQuiz: [
      ...
      },
      {
        ...
        answer: "-4, -1, 1, 5",
        options: ["-4, -1, 1, 5", "1, -1, 5, -4", "-1, -4, 1, 5", "5, 1, -1, -4"],
        distractors: ["1, -1, 5, -4", "-1, -4, 1, 5", "5, 1, -1, -4"],
      ...
      },
      {
        ...
        answer: "-35 feet",
        options: ["-35 feet", "-85 feet", "35 feet", "-25 feet"],
        distractors: ["-85 feet", "35 feet", "-25 feet"],
  ...
  },
  {
    ...
    skills: ["Plot points", "Quadrants", "Distance", "Reflections"],
    lessons: 4,
    objective:
    ...
    bank: [
      {
        ...
        answer: "The origin",
        options: ["The origin", "The center axis", "Quadrant I", "The y-intercept"],
        distractors: ["The center axis", "Quadrant I", "The y-intercept"],
      ...
      },
      {
        ...
        distractors: ["y-axis", "z-axis", "origin"],
      ...
      },
      {
        ...
        answer: "Up 4",
        options: ["Up 4", "Down 4", "Left 4", "Right 4"],
        distractors: ["Down 4", "Left 4", "Right 4"],
      ...
      },
      {
        ...
        distractors: ["Quadrant II", "Quadrant III", "Quadrant IV"],
      ...
      },
      {
        ...
        distractors: ["Quadrant I", "Quadrant II", "Quadrant IV"],
      ...
      },
      {
        ...
        distractors: ["Quadrant I", "Quadrant II", "Quadrant III"],
      ...
      },
      {
        ...
        answer: "y-axis",
        options: ["y-axis", "x-axis", "Quadrant I", "Quadrant II"],
        distractors: ["x-axis", "Quadrant I", "Quadrant II"],
        explain: "When the x-coordinate is 0, the point sits on the vertical y-axis.",
      },
      {
        prompt: "The point (-7, 0) lies on which axis?",
        answer: "x-axis",
        options: ["x-axis", "y-axis", "Quadrant III", "origin"],
        distractors: ["y-axis", "Quadrant III", "origin"],
      ...
      },
      {
        ...
        answer: "7 units",
        options: ["7 units", "8 units", "11 units", "10 units"],
        distractors: ["8 units", "11 units", "10 units"],
        explain: "Same x means a vertical line, so subtract the y-values: 9 - 2 = 7.",
      },
      {
        prompt: "What is the distance between (3, 4) and (10, 4)?",
        answer: "7 units",
        options: ["7 units", "6 units", "14 units", "13 units"],
        distractors: ["6 units", "14 units", "13 units"],
      ...
      },
      {
        ...
        distractors: ["(6, -2)", "(6, 2)", "(-2, -6)"],
        explain: "Across the x-axis, keep x and flip y: -2 becomes 2, giving (-6, 2).",
      },
      {
        prompt:
          "Maria walks her dog from the gate at (2, 3) to the bench at (2, 11) on a park map where each unit is 1 meter. How far does she walk?",
        answer: "8 meters",
        options: ["8 meters", "9 meters", "14 meters", "13 meters"],
        distractors: ["9 meters", "14 meters", "13 meters"],
        explain: "Same x means a vertical path: 11 - 3 = 8 meters.",
      },
      {
        prompt:
          "On a map, a school is at (-5, 4) and a library is at (3, 4), where each unit is 1 block. How many blocks apart are they?",
        answer: "8 blocks",
        options: ["8 blocks", "2 blocks", "7 blocks", "12 blocks"],
        distractors: ["2 blocks", "7 blocks", "12 blocks"],
        explain: "Same y, so count from -5 to 3 along the x-axis: that is 8 blocks.",
      },
      {
        prompt:
          "A treasure chest is at (-4, -6). On the map, treasures in Quadrant III are buried. Is the chest in the buried zone?",
      ...
      {
        prompt:
          "A drone starts at (7, -3). It flies to its mirror spot reflected across the x-axis. Where does it land?",
        answer: "(7, 3)",
        options: ["(7, 3)", "(-7, -3)", "(-7, 3)", "(-3, 7)"],
        distractors: ["(-7, -3)", "(-7, 3)", "(-3, 7)"],
        explain: "Across the x-axis, keep x and flip y: -3 becomes 3, giving (7, 3).",
      },
      {
        prompt:
          "Two friends sit at (-6, 2) and (-6, -7) on a seating grid where each unit is 1 seat. How many seats apart are they?",
        answer: "9 seats",
        options: ["9 seats", "5 seats", "8 seats", "13 seats"],
        distractors: ["5 seats", "8 seats", "13 seats"],
        explain: "Same x, so find the y-gap: from 2 down to -7 is 9 seats.",
      },
      {
        prompt:
          "A rectangle has corners at (1, 2), (8, 2), (8, 6), and (1, 6). What is the length of its bottom side from (1, 2) to (8, 2)?",
        answer: "7 units",
        options: ["7 units", "4 units", "9 units", "6 units"],
        distractors: ["4 units", "9 units", "6 units"],
        explain: "The bottom side is horizontal, so subtract x-values: 8 - 1 = 7 units.",
      },
      {
        prompt:
          "A hiker at (-5, 8) reflects her position across the y-axis to mark a return point, then walks straight down to the x-axis. How many total units does she travel for both moves?",
        answer: "18 units",
        options: ["18 units", "16 units", "13 units", "10 units"],
        distractors: ["16 units", "13 units", "10 units"],
        explain:
          "Reflection across the y-axis moves from -5 to 5, a 10-unit horizontal trip; then down 8 units to the x-axis; 10 + 8 = 18.",
      },
    ],
    worksheetA: [
      {
    ...
    preQuiz: [
      ...
      },
      {
        ...
        answer: "y-axis",
        options: ["y-axis", "x-axis", "Quadrant I", "origin"],
        distractors: ["x-axis", "Quadrant I", "origin"],
        explain: "When x is 0, the point sits on the vertical y-axis.",
      },
      {
        prompt: "What is the distance between (3, 2) and (3, 8)?",
        answer: "6 units",
        options: ["6 units", "5 units", "11 units", "10 units"],
        distractors: ["5 units", "11 units", "10 units"],
        explain: "Same x means a vertical line: 8 - 2 = 6 units.",
      },
      {
        prompt: "What is the distance between (2, 5) and (9, 5)?",
        answer: "7 units",
        options: ["7 units", "4 units", "14 units", "11 units"],
        distractors: ["4 units", "14 units", "11 units"],
      ...
      },
      {
        ...
        distractors: ["(-4, 6)", "(-4, -6)", "(6, 4)"],
        explain: "Across the x-axis, keep x and flip y, giving (4, -6).",
      },
      {
        prompt:
          "A library is at (-7, 2) and a park at (4, 2), each unit 1 block. How many blocks apart are they?",
        answer: "11 blocks",
        options: ["11 blocks", "3 blocks", "9 blocks", "5 blocks"],
        distractors: ["3 blocks", "9 blocks", "5 blocks"],
    ...
    postQuiz: [
      ...
      },
      {
        ...
        answer: "y-axis",
        options: ["y-axis", "x-axis", "Quadrant IV", "origin"],
        distractors: ["x-axis", "Quadrant IV", "origin"],
        explain: "When x is 0, the point sits on the vertical y-axis.",
      },
      {
        prompt: "What is the distance between (5, 1) and (5, 9)?",
        answer: "8 units",
        options: ["8 units", "4 units", "14 units", "10 units"],
        distractors: ["4 units", "14 units", "10 units"],
        explain: "Same x means a vertical line: 9 - 1 = 8 units.",
      },
      {
        prompt: "What is the distance between (3, 6) and (11, 6)?",
        answer: "8 units",
        options: ["8 units", "5 units", "17 units", "14 units"],
        distractors: ["5 units", "17 units", "14 units"],
      ...
      },
      {
        ...
        distractors: ["(-5, 7)", "(-5, -7)", "(7, 5)"],
        explain: "Across the x-axis, keep x and flip y, giving (5, -7).",
      },
      {
        prompt:
          "A store is at (-8, 3) and a school at (5, 3), each unit 1 block. How many blocks apart are they?",
        answer: "13 blocks",
        options: ["13 blocks", "3 blocks", "11 blocks", "6 blocks"],
        distractors: ["3 blocks", "11 blocks", "6 blocks"],
  ...
  },
  {
    ...
    skills: ["Exponents", "Evaluate", "Write expressions", "Like terms"],
    lessons: 4,
    objective:
    ...
    bank: [
      {
        ...
        answer: "5^3",
        options: ["5^3", "5^5", "3^5", "5 × 3"],
        distractors: ["5^5", "3^5", "5 × 3"],
      ...
      },
      {
        ...
        answer: "p - 12",
        options: ["p - 12", "12 - p", "p + 12", "12p"],
        distractors: ["12 - p", "p + 12", "12p"],
        explain: '"Less than" reverses the order, so it is p - 12.',
      },
      {
        prompt: "Combine like terms: 3x + 5x.",
        answer: "8x",
        options: ["8x", "8", "15x", "8x^2"],
        distractors: ["8", "15x", "8x^2"],
      ...
      },
      {
        ...
        answer: "10y + 2",
        options: ["10y + 2", "12y", "10y", "9y + 3"],
        distractors: ["12y", "10y", "9y + 3"],
      ...
      },
      {
        ...
        answer: "13",
        options: ["13", "10", "49", "11"],
        distractors: ["10", "49", "11"],
        explain: "3^2 = 9, then 9 + 4 = 13.",
      },
      {
        prompt: "Use the distributive property: 5(x - 2).",
        answer: "5x - 10",
        options: ["5x - 10", "5x - 2", "x - 10", "5x + 10"],
        distractors: ["5x - 2", "x - 10", "5x + 10"],
      ...
      },
      {
        ...
        answer: "6t",
        options: ["6t", "t + 6", "t - 6", "6 + t"],
        distractors: ["t + 6", "t - 6", "6 + t"],
        explain: "6 tickets each costing t means 6 × t = 6t.",
      },
      {
        prompt:
          "Maria has b books. Her friend has 5 more than twice as many. Which expression shows the friend's books?",
        answer: "2b + 5",
        options: ["2b + 5", "2b - 5", "b + 5", "5b + 2"],
        distractors: ["2b - 5", "b + 5", "5b + 2"],
      ...
      },
      {
        ...
        answer: "s^2",
        options: ["s^2", "4s", "2s", "s × 4"],
        distractors: ["4s", "2s", "s × 4"],
        explain: "Area of a square is side times side, which is s × s = s^2.",
      },
      {
        prompt: "Simplify: 3(x + 2) + 4x.",
        answer: "7x + 6",
        options: ["7x + 6", "7x + 2", "3x + 6", "7x + 8"],
        distractors: ["7x + 2", "3x + 6", "7x + 8"],
        explain: "Distribute to get 3x + 6, then add 4x: 3x + 4x = 7x, so 7x + 6.",
      },
      {
        prompt:
          "A bag holds 8 marbles. You buy x more bags. Write an expression for the total marbles, then evaluate when x = 3.",
        answer: "8x = 24",
        options: ["8x = 24", "8 + x = 11", "8x = 11", "x + 3 = 11"],
        distractors: ["8 + x = 11", "8x = 11", "x + 3 = 11"],
        explain: "x bags of 8 is 8x; when x = 3, 8 × 3 = 24.",
      },
      {
        prompt:
          "A taxi charges $4 to start plus $2 for each mile m. Simplify the total cost for 2 trips: 2(4 + 2m).",
        answer: "8 + 4m",
        options: ["8 + 4m", "8 + 2m", "6 + 2m", "4 + 4m"],
        distractors: ["8 + 2m", "6 + 2m", "4 + 4m"],
    ...
    preQuiz: [
      {
        ...
        answer: "2^5",
        options: ["2^5", "5^2", "2^4", "2 × 5"],
        distractors: ["5^2", "2^4", "2 × 5"],
      ...
      },
      {
        ...
        answer: "n + 5",
        options: ["n + 5", "5 - n", "5n", "n - 5"],
        distractors: ["5 - n", "5n", "n - 5"],
        explain: '"More than" means add, so it is n + 5.',
      },
      {
        prompt: "Combine like terms: 2x + 7x.",
        answer: "9x",
        options: ["9x", "9", "14x", "9x^2"],
        distractors: ["9", "14x", "9x^2"],
      ...
      },
      {
        ...
        answer: "5b",
        options: ["5b", "b + 5", "b - 5", "5 + b"],
        distractors: ["b + 5", "b - 5", "5 + b"],
    ...
    postQuiz: [
      {
        ...
        answer: "3^4",
        options: ["3^4", "4^3", "3^3", "3 × 4"],
        distractors: ["4^3", "3^3", "3 × 4"],
  ...
  },
  {
    ...
    skills: ["Solve 1-step", "Check", "Inequalities", "Variables"],
    lessons: 4,
    objective:
    ...
    bank: [
      {
        ...
        answer: "x + 3 = 9",
        options: ["x + 3 = 9", "x + 3", "2x > 9", "add 3 to x"],
        distractors: ["x + 3", "2x > 9", "add 3 to x"],
      ...
      },
      {
        prompt: "Solve: m - 5 = 8",
        answer: "13",
        options: ["13", "3", "40", "13.5"],
        distractors: ["3", "40", "13.5"],
      ...
      },
      {
        ...
        options: ["subtracting 6", "adding 6", "multiplying by 6", "dividing by 6"],
        distractors: ["adding 6", "multiplying by 6", "dividing by 6"],
      ...
      },
      {
        ...
        distractors: ["No, because 4 + 2 = 8", "Yes, because 6 - 4 = 1", "No, because x must be 8"],
      ...
      },
      {
        ...
        options: ["An open (empty) dot", "A closed (filled) dot", "No dot at all", "Two dots"],
        distractors: ["A closed (filled) dot", "No dot at all", "Two dots"],
      ...
      },
      {
        ...
        answer: "t",
        options: ["t", "y", "2", "none"],
        distractors: ["y", "2", "none"],
        explain: "The independent variable t is the input you choose; y depends on it.",
      },
      {
        prompt:
          "Maria saved $15 and now has $40. The equation 15 + x = 40 finds extra money saved. How much is x?",
        answer: "$25",
        options: ["$25", "$55", "$15", "$2.67"],
        distractors: ["$55", "$15", "$2.67"],
        explain: "Subtract 15 from both sides: 40 - 15 = 25.",
      },
      {
        prompt:
          "A pizza is cut into equal slices. If 5 friends each get 3 slices, the equation s ÷ 5 = 3 finds total slices s. Find s.",
        answer: "15",
        options: ["15", "8", "2", "20"],
        distractors: ["8", "2", "20"],
      ...
      {
        prompt:
          "A movie ticket costs $9. Total cost for n tickets is 9n = 63. How many tickets were bought?",
        answer: "7",
        options: ["7", "54", "72", "9"],
        distractors: ["54", "72", "9"],
      ...
      {
        prompt:
          "To ride a roller coaster you must be at least 48 inches tall. Which inequality shows allowed height h?",
        answer: "h ≥ 48",
        options: ["h ≥ 48", "h ≤ 48", "h > 48", "h < 48"],
        distractors: ["h ≤ 48", "h > 48", "h < 48"],
        explain: "'At least 48' includes 48, so h ≥ 48.",
      },
      {
        prompt:
          "A class has fewer than 30 students. Which inequality shows the number of students s?",
        answer: "s < 30",
        options: ["s < 30", "s > 30", "s ≤ 30", "s ≥ 30"],
        distractors: ["s > 30", "s ≤ 30", "s ≥ 30"],
      ...
      {
        prompt:
          "Devon walks d miles each day. After 6 days he walked 18 miles, shown by 6d = 18. He wants to walk more than 3 miles per day going forward. Which is true now and what should the new goal look like?",
    ...
    preQuiz: [
      ...
      },
      {
        prompt: "Solve: x - 4 = 9",
        answer: "13",
        options: ["13", "5", "36", "13.5"],
        distractors: ["5", "36", "13.5"],
      ...
      {
        prompt:
          "A box holds 8 crayons. The equation 8b = 56 finds the number of boxes b for 56 crayons. Find b.",
        answer: "7",
        options: ["7", "48", "64", "8"],
        distractors: ["48", "64", "8"],
    ...
    postQuiz: [
      ...
      },
      {
        prompt: "Solve: x - 6 = 10",
        answer: "16",
        options: ["16", "4", "60", "16.5"],
        distractors: ["4", "60", "16.5"],
      ...
      },
      {
        ...
        answer: "7",
        options: ["7", "56", "42", "343"],
        distractors: ["56", "42", "343"],
        explain: "Divide both sides by 7: 49 ÷ 7 = 7.",
      },
      {
        prompt: "Solve: x ÷ 3 = 8",
        answer: "24",
        options: ["24", "5", "11", "2.67"],
        distractors: ["5", "11", "2.67"],
      ...
      },
      {
        ...
        distractors: ["x ≥ 9", "x < 9", "x > 9"],
        explain: "'At most 9' includes 9, so x ≤ 9.",
      },
      {
        prompt:
          "A pack holds 9 stickers. The equation 9p = 63 finds the number of packs p for 63 stickers. Find p.",
        answer: "7",
        options: ["7", "54", "72", "9"],
        distractors: ["54", "72", "9"],
  ...
  },
  {
    ...
    skills: ["Area", "Composite area", "Volume", "Surface area"],
    lessons: 4,
    objective:
      "I can find the area of triangles, parallelograms, trapezoids, and composite figures, and the surface area and volume of rectangular prisms.",
    estMin: 30,
    vocab: [
      {
        term: "Area",
    ...
    workedExamples: [
      ...
      {
        problem:
          "Find the area of a trapezoid with parallel sides 6 m and 10 m and a height of 4 m.",
        steps: [
    ...
    bank: [
      {
        ...
        answer: "24 cm²",
        options: ["24 cm²", "10 cm²", "20 cm²", "48 cm²"],
        distractors: ["10 cm²", "20 cm²", "48 cm²"],
      ...
      },
      {
        ...
        answer: "35 in²",
        options: ["35 in²", "24 in²", "12 in²", "70 in²"],
        distractors: ["24 in²", "12 in²", "70 in²"],
      ...
      },
      {
        ...
        answer: "45 m²",
        options: ["45 m²", "28 m²", "14 m²", "90 m²"],
        distractors: ["28 m²", "14 m²", "90 m²"],
        explain: "Area equals base times height: 9 × 5 = 45.",
      },
      {
        prompt: "A triangle has base 10 ft and height 6 ft. What is its area?",
        answer: "30 ft²",
        options: ["30 ft²", "60 ft²", "16 ft²", "32 ft²"],
        distractors: ["60 ft²", "16 ft²", "32 ft²"],
        explain: "Triangle area is ½ × base × height: ½ × 10 × 6 = 30.",
      },
      {
        prompt:
          "What is the area of a trapezoid with parallel sides 4 cm and 6 cm and height 3 cm?",
        answer: "15 cm²",
        options: ["15 cm²", "30 cm²", "13 cm²", "72 cm²"],
        distractors: ["30 cm²", "13 cm²", "72 cm²"],
        explain:
          "Add the two parallel sides, divide by 2, then multiply by height: (4+6)/2 × 3 = 15.",
      },
      {
        prompt: "What is the area of a triangle with base 7 m and height 4 m?",
        answer: "14 m²",
        options: ["14 m²", "28 m²", "11 m²", "22 m²"],
        distractors: ["28 m²", "11 m²", "22 m²"],
        explain: "Triangle area is ½ × 7 × 4 = 14.",
      },
      {
        prompt: "What is the volume of a box that is 4 cm by 3 cm by 2 cm?",
        answer: "24 cm³",
        options: ["24 cm³", "9 cm³", "26 cm³", "52 cm³"],
        distractors: ["9 cm³", "26 cm³", "52 cm³"],
        explain: "Volume is length × width × height: 4 × 3 × 2 = 24.",
      },
      {
        prompt:
          "A trapezoid has parallel sides 6 in and 10 in and a height of 4 in. What is its area?",
        answer: "32 in²",
        options: ["32 in²", "64 in²", "40 in²", "20 in²"],
        distractors: ["64 in²", "40 in²", "20 in²"],
        explain: "(6+10)/2 × 4 = 8 × 4 = 32.",
      },
      {
        prompt: "What is the surface area of a cube with edge length 5 cm?",
        answer: "150 cm²",
        options: ["150 cm²", "125 cm²", "25 cm²", "30 cm²"],
        distractors: ["125 cm²", "25 cm²", "30 cm²"],
      ...
      },
      {
        ...
        answer: "60 m³",
        options: ["60 m³", "12 m³", "94 m³", "20 m³"],
        distractors: ["12 m³", "94 m³", "20 m³"],
        explain: "Volume is 5 × 4 × 3 = 60.",
      },
      {
        prompt: "A triangle has base 9 cm and height 6 cm. What is its area?",
        answer: "27 cm²",
        options: ["27 cm²", "54 cm²", "15 cm²", "30 cm²"],
        distractors: ["54 cm²", "15 cm²", "30 cm²"],
        explain: "Triangle area is ½ × 9 × 6 = 27.",
      },
      {
        prompt: "What is the volume of a box that is 2½ ft by 4 ft by 3 ft?",
        answer: "30 ft³",
        options: ["30 ft³", "9½ ft³", "24 ft³", "15 ft³"],
        distractors: ["9½ ft³", "24 ft³", "15 ft³"],
        explain: "Volume is 2½ × 4 × 3 = 30.",
      },
      {
        prompt:
          "A composite figure is a 8 cm by 5 cm rectangle with a triangle on top (base 8 cm, height 3 cm). What is the total area?",
        answer: "52 cm²",
        options: ["52 cm²", "40 cm²", "64 cm²", "46 cm²"],
        distractors: ["40 cm²", "64 cm²", "46 cm²"],
      ...
      },
      {
        ...
        answer: "94 in²",
        options: ["94 in²", "60 in²", "47 in²", "120 in²"],
        distractors: ["60 in²", "47 in²", "120 in²"],
      ...
      },
      {
        ...
        answer: "50 m²",
        options: ["50 m²", "100 m²", "60 m²", "25 m²"],
        distractors: ["100 m²", "60 m²", "25 m²"],
        explain: "(8+12)/2 × 5 = 10 × 5 = 50.",
      },
      {
        prompt:
          "A flower bed is shaped like a triangle with base 12 ft and height 5 ft. How much area does it cover?",
        answer: "30 ft²",
        options: ["30 ft²", "60 ft²", "17 ft²", "34 ft²"],
        distractors: ["60 ft²", "17 ft²", "34 ft²"],
        explain: "Triangle area is ½ × 12 × 5 = 30.",
      },
      {
        prompt: "A fish tank is 5 dm long, 3 dm wide, and 2.5 dm tall. What is its volume?",
        answer: "37.5 dm³",
        options: ["37.5 dm³", "10.5 dm³", "30 dm³", "75 dm³"],
        distractors: ["10.5 dm³", "30 dm³", "75 dm³"],
        explain: "Volume is 5 × 3 × 2.5 = 37.5.",
      },
      {
        prompt: "A small box is ¾ ft by ½ ft by 2 ft. What is its volume?",
        answer: "¾ ft³",
        options: ["¾ ft³", "3¼ ft³", "1½ ft³", "1 ft³"],
        distractors: ["3¼ ft³", "1½ ft³", "1 ft³"],
        explain: "Volume is ¾ × ½ × 2 = ¾.",
      },
      {
        prompt: "How many unit cubes with ⅓-ft edges fill a box that is 2 ft by 1 ft by ⅔ ft?",
        answer: "36 cubes",
        options: ["36 cubes", "12 cubes", "4 cubes", "27 cubes"],
        distractors: ["12 cubes", "4 cubes", "27 cubes"],
        explain: "Box volume is 2×1×⅔ = 4/3 ft³; each cube is 1/27 ft³, so (4/3)÷(1/27) = 36.",
      },
      {
        prompt:
          "You wrap a gift box that is 6 in by 2 in by 3 in. How much wrapping paper (surface area) do you need at minimum?",
        answer: "72 in²",
        options: ["72 in²", "36 in²", "52 in²", "144 in²"],
        distractors: ["36 in²", "52 in²", "144 in²"],
        explain: "Surface area is 2(6×2 + 6×3 + 2×3) = 2(12+18+6) = 72.",
      },
      {
        prompt:
          "A garden is a rectangle 10 m by 6 m with a triangular section removed (base 6 m, height 4 m). What area is left?",
        answer: "48 m²",
        options: ["48 m²", "60 m²", "36 m²", "12 m²"],
        distractors: ["60 m²", "36 m²", "12 m²"],
        explain: "Rectangle 10×6 = 60, triangle ½×6×4 = 12, remaining 60−12 = 48.",
      },
      {
        prompt:
          "A net shows a rectangular prism 10 cm by 4 cm by 5 cm. What is the total surface area?",
        answer: "220 cm²",
        options: ["220 cm²", "200 cm²", "110 cm²", "240 cm²"],
        distractors: ["200 cm²", "110 cm²", "240 cm²"],
      ...
      },
      {
        ...
        answer: "7½ ft³",
        options: ["7½ ft³", "6 ft³", "5 ft³", "9 ft³"],
        distractors: ["6 ft³", "5 ft³", "9 ft³"],
    ...
    preQuiz: [
      {
        ...
        answer: "20 cm²",
        options: ["20 cm²", "9 cm²", "18 cm²", "40 cm²"],
        distractors: ["9 cm²", "18 cm²", "40 cm²"],
        explain: "Area is base × height: 5 × 4 = 20.",
      },
      {
        prompt: "A triangle has base 8 m and height 6 m. What is its area?",
        answer: "24 m²",
        options: ["24 m²", "48 m²", "14 m²", "28 m²"],
        distractors: ["48 m²", "14 m²", "28 m²"],
        explain: "Triangle area is ½ × 8 × 6 = 24.",
      },
      {
        prompt:
          "What is the area of a trapezoid with parallel sides 4 cm and 8 cm and height 5 cm?",
        answer: "30 cm²",
        options: ["30 cm²", "60 cm²", "20 cm²", "40 cm²"],
        distractors: ["60 cm²", "20 cm²", "40 cm²"],
        explain: "(4+8)/2 × 5 = 6 × 5 = 30.",
      },
      {
        prompt: "What is the volume of a box that is 6 cm by 2 cm by 4 cm?",
        answer: "48 cm³",
        options: ["48 cm³", "12 cm³", "88 cm³", "24 cm³"],
        distractors: ["12 cm³", "88 cm³", "24 cm³"],
        explain: "Volume is 6 × 2 × 4 = 48.",
      },
      {
        prompt: "What is the surface area of a cube with edge length 3 in?",
        answer: "54 in²",
        options: ["54 in²", "27 in²", "9 in²", "18 in²"],
        distractors: ["27 in²", "9 in²", "18 in²"],
        explain: "A cube has 6 equal faces: 6 × (3×3) = 54.",
      },
      {
        prompt: "A box is ½ ft by 4 ft by 3 ft. What is its volume?",
        answer: "6 ft³",
        options: ["6 ft³", "7½ ft³", "12 ft³", "2 ft³"],
        distractors: ["7½ ft³", "12 ft³", "2 ft³"],
        explain: "Volume is ½ × 4 × 3 = 6.",
      },
      {
        prompt:
          "A composite figure is a 5 cm by 4 cm rectangle with a triangle on top (base 5 cm, height 2 cm). What is the total area?",
        answer: "25 cm²",
        options: ["25 cm²", "20 cm²", "30 cm²", "23 cm²"],
        distractors: ["20 cm²", "30 cm²", "23 cm²"],
        explain: "Rectangle 5×4 = 20, triangle ½×5×2 = 5, total 20+5 = 25.",
      },
      {
        prompt:
          "You wrap a box that is 7 in by 3 in by 2 in. How much paper (surface area) do you need?",
        answer: "82 in²",
        options: ["82 in²", "42 in²", "41 in²", "164 in²"],
        distractors: ["42 in²", "41 in²", "164 in²"],
    ...
    postQuiz: [
      {
        ...
        answer: "35 cm²",
        options: ["35 cm²", "12 cm²", "24 cm²", "70 cm²"],
        distractors: ["12 cm²", "24 cm²", "70 cm²"],
      ...
      {
        prompt:
          "What is the area of a trapezoid with parallel sides 5 cm and 7 cm and height 4 cm?",
        answer: "24 cm²",
        options: ["24 cm²", "48 cm²", "16 cm²", "35 cm²"],
        distractors: ["48 cm²", "16 cm²", "35 cm²"],
        explain: "(5+7)/2 × 4 = 6 × 4 = 24.",
      },
      {
        prompt: "What is the volume of a box that is 5 cm by 3 cm by 4 cm?",
        answer: "60 cm³",
        options: ["60 cm³", "12 cm³", "94 cm³", "23 cm³"],
        distractors: ["12 cm³", "94 cm³", "23 cm³"],
        explain: "Volume is 5 × 3 × 4 = 60.",
      },
      {
        prompt: "What is the surface area of a cube with edge length 4 in?",
        answer: "96 in²",
        options: ["96 in²", "64 in²", "16 in²", "24 in²"],
        distractors: ["64 in²", "16 in²", "24 in²"],
        explain: "A cube has 6 equal faces: 6 × (4×4) = 96.",
      },
      {
        prompt: "A box is ½ ft by 3 ft by 2 ft. What is its volume?",
        answer: "3 ft³",
        options: ["3 ft³", "5½ ft³", "6 ft³", "1½ ft³"],
        distractors: ["5½ ft³", "6 ft³", "1½ ft³"],
        explain: "Volume is ½ × 3 × 2 = 3.",
      },
      {
        prompt:
          "A composite figure is a 6 cm by 4 cm rectangle with a triangle on top (base 6 cm, height 4 cm). What is the total area?",
        answer: "36 cm²",
        options: ["36 cm²", "24 cm²", "48 cm²", "30 cm²"],
        distractors: ["24 cm²", "48 cm²", "30 cm²"],
        explain: "Rectangle 6×4 = 24, triangle ½×6×4 = 12, total 24+12 = 36.",
      },
      {
        prompt:
          "You wrap a box that is 8 in by 3 in by 2 in. How much paper (surface area) do you need?",
        answer: "92 in²",
        options: ["92 in²", "48 in²", "46 in²", "184 in²"],
        distractors: ["48 in²", "46 in²", "184 in²"],
  ...
  },
  {
    ...
    skills: ["Mean / median", "Range & MAD", "Dot plots", "Histograms"],
    lessons: 4,
    objective:
    ...
    bank: [
      {
        ...
        distractors: ["How tall am I?", "What is my shoe size?", "How old is the teacher?"],
        explain:
          "A statistical question expects many different answers, like the varying heights of students.",
      },
      {
      ...
      },
      {
        ...
        distractors: ["8 people are exactly age 10", "The mean age is 8", "There are 8 age groups"],
      ...
      },
      {
        ...
        distractors: ["The mean", "The range", "The mode"],
      ...
      {
        prompt:
          "A store sold these many shirts over 6 days: 3, 7, 7, 9, 12, 14. What is the median?",
        answer: "8",
        options: ["8", "7", "9", "7.5"],
        distractors: ["7", "9", "7.5"],
      ...
      },
      {
        ...
        answer: "85",
        options: ["85", "84", "88", "80"],
        distractors: ["84", "88", "80"],
        explain: "Sum is 340; 340 / 4 = 85.",
      },
      {
        prompt: "Which measure is most affected by one very large outlier value?",
        answer: "Mean",
        options: ["Mean", "Median", "Mode", "Range of the middle half"],
        distractors: ["Median", "Mode", "Range of the middle half"],
      ...
      },
      {
        ...
        answer: "64",
        options: ["64", "68", "66", "74"],
        distractors: ["68", "66", "74"],
        explain: "64 appears twice, more than any other value, so it is the mode.",
      },
      {
        prompt:
          "A basketball player scored a mean of 20 points over 4 games. What was her total points?",
        answer: "80",
        options: ["80", "24", "20", "5"],
        distractors: ["24", "20", "5"],
      ...
      {
        prompt:
          "Three test scores are 75, 85, and 90. What score is needed on a 4th test to average 80?",
        answer: "70",
        options: ["70", "80", "75", "85"],
        distractors: ["80", "75", "85"],
        explain: "Needed total is 80 x 4 = 320; 320 - (75+85+90) = 70.",
      },
      {
        prompt:
          "Data set: 5, 8, 8, 11, 13. The mean is 9. What is the mean absolute deviation (MAD)?",
        answer: "2.4",
        options: ["2.4", "8", "9", "2"],
        distractors: ["8", "9", "2"],
      ...
      {
        prompt:
          "Two classes have the same mean test score, but Class A has MAD 2 and Class B has MAD 9. What does this tell you?",
        ...
        explain:
          "A smaller MAD means the data is closer to the mean, so Class A is more clustered.",
      },
    ],
    worksheetA: [
      {
    ...
    preQuiz: [
      ...
      },
      {
        ...
        distractors: ["The value 6 appears 4 times", "The total is 24", "The mean is 4"],
    ...
    postQuiz: [
      ...
      },
      {
        ...
        distractors: ["The value 5 appears 3 times", "The total is 15", "The mean is 3"],
