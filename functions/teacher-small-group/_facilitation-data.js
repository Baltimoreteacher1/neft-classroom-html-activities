...
>>>>>>> origin/main
  ...
  "1-2-group1": {
    ...
    "moves": [
      ...
      "Release to the practice problems; the hint ladder is the safety net.",
<<<<<<< HEAD
      "Watch for the common mistake: A common mistake in Greatest Common Factor is confusing it with the Least Common Multiple: some students list the MULTIPLES of both numbers and pick the smallest shared one (getting an answer bigger than either number, like 72 for 24 and 36) instead of listing FACTORS and picking the largest one they share (12). Remember: the GCF splits numbers INTO equal groups, so it can never be bigger than the smaller of the two numbers.",
      "Close with the exit-ticket check — celebrate the growth."
||||||| 540ecb4e3
      "Watch for the common mistake: A common mistake in Greatest Common Factor is confusing it with the Least Common Multiple: some students list the MULTIPLES of both numbers and pick the smallest shared one (getting an answer bigger than either number, like 72 for 24 and 36) instead of listing FACTORS and picking the largest one they share (12). Remember: the GCF splits numbers INTO equal groups, so it can never be bigger than the smaller of the two numbers.",
      "Close with the exit-ticket check — celebrate the growth.",
...
>>>>>>> origin/main
  ...
  "2-5-group1": {
    ...
    listenFor: [
      "Students explain different data produces different shapes and can describe symmetric (balanced) versus skewed (lopsided) distributions.",
      "A strong answer says symmetric data mirrors around the center while skewed data has a longer tail pulling to the left or right.",
      "Students identify the right-skewed shape (long tail of slow runners) and choose the median because the slow tail would pull the mean up.",
      "Students describe a right-skewed shape (cluster at 40-60, gap, then 90-100) and choose the median because the high values would inflate the mean.",
      'Listen for students naming a specific strategy tied to 6.DS.3 — not just "I multiplied." They should connect steps to the key idea.',
    ],
  },
  "2-5-group2": {
    group: 2,
...
=======
  "6-4-group1": {
    ...
    label: "Extra Support",
    duration: "15–20 min",
    who: "Pull 3–5 students by the error they actually made on this lesson's check — this one diagnoses: Added when the problem multiplies; Worked left to right instead of by operation order. Group students who made the SAME error; they need different repairs.",
    moves: [
>>>>>>> origin/main
      "Open with the worked example (I Do) — think aloud, don't just show.",
      "Do the We Do together; require every student to say the sentence frame.",
      "Release to the practice problems; the hint ladder is the safety net.",
      "Watch for the common mistake: A common mistake in Evaluate Expressions is treating a coefficient like an addend instead of a factor — for example, evaluating 3x + 7 when x = 4 as 3 + 4 + 7 = 14 instead of the correct 3(4) + 7 = 12 + 7 = 19. A number written right next to a variable always means multiply, never add. Before you submit, ask: \"Did I multiply the coefficient by the value I substituted, or did I accidentally add it?\".",
      "Close with the exit-ticket check — celebrate the growth."
    ],
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
