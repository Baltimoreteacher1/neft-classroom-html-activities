...
export const FACILITATION_BY_LESSON = {
  ...
  "1-1-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Added when the problem multiplies” error fails in every case, not just this one.",
  ...
  "1-2-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students expecting a fraction of a number to be bigger than the number — 5/6 × 540 must be LESS than 540 because 5/6 is less than 1; only a fraction greater than 1, like 6/5, makes the product bigger.",
      "ifStuck": "Go back to the number line and rebuild the first step together before releasing them."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
      "I know because ___ ."
  ...
  "10-3-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students doubling the previous number of steps but forgetting to add 1 — answering 14 instead of 15 for four discs, or 30 instead of 31 for five.",
      "ifStuck": "Go back to the bar graph and rebuild the first step together before releasing them."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
      "I know because ___ ."
  ...
  "10-4-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Divided in the wrong order” error fails in every case, not just this one.",
  ...
  "10-5-group1": {
    ...
    "teacherMoves": {
      "ask": "Show me on the bar graph where your numbers came from.",
      "lookFor": "Students calling every repeated design a 'pattern.' One identical shape repeated is repetition; a pattern needs a unit of shapes repeating in a regular order; and rhythm varies the shapes' size and order, so it is neither.",
      "ifStuck": "Go back to the bar graph and rebuild the first step together before releasing them."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
  ...
  "2-10-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Chose the mean when an outlier distorts it” error fails in every case, not just this one.",
  ...
  "2-11-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Right digits, wrong magnitude” error fails in every case, not just this one.",
  ...
  "2-2-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students misread the bins or the scale on a data display — that is this lesson's error.",
      "ifStuck": "Have them point to the interval's two endpoints and say which values belong inside it."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
      "I know because ___ ."
  ...
  "2-2-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Misread the bins or the scale on a data display” error fails in every case, not just this one.",
      "ifStuck": "Ask them to rebin the same data on the histogram and say whether the story changed.",
      "extend": "Ask which measure they would report to argue each side, and what that reveals."
    },
    "listenFor": [
      "Students explain grouping into intervals makes 30 values readable and that each bar's height is the frequency for that interval.",
  ...
  "2-3-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students used the mean where the median was asked (or the reverse) — that is this lesson's error.",
      "ifStuck": "Ask them to say which word the question used, then what that word tells you to DO with the numbers."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
      "I know because ___ ."
  ...
  "2-3-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Used the mean where the median was asked (or the reverse)” error fails in every case, not just this one.",
  ...
  "2-4-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students confused a measure of center with a measure of spread — that is this lesson's error.",
      "ifStuck": "Ask what the question wants to know: a typical value, or how scattered the data is?."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
      "I know because ___ ."
  ...
  "2-4-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Confused a measure of center with a measure of spread” error fails in every case, not just this one.",
  ...
  "2-5-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Used the full range instead of the IQR” error fails in every case, not just this one.",
  ...
  "2-8-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Added the data set instead of averaging it” error fails in every case, not just this one.",
      "ifStuck": "Hand them a second data set on the dot plot and ask which claim survives both.",
      "extend": "Ask which measure they would report to argue each side, and what that reveals."
    },
    "listenFor": [
  ...
  "3-1-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Flipped the ratio” error fails in every case, not just this one.",
  ...
  "3-2-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Gave the total instead of the unit rate” error fails in every case, not just this one.",
      "ifStuck": "Shrink it: give them a 1-to-something case on the unit-rate table, then ask what changed.",
      "extend": "Ask them to write a ratio that is NOT equivalent, and justify why it fails."
    },
    "listenFor": [
      "Students notice the prices cannot be compared directly because the number of games differs, so they need the cost for one game (the unit rate) to compare fairly.",
  ...
  "3-3-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students scaled a ratio by adding instead of multiplying — that is this lesson's error.",
      "ifStuck": "Ask what ONE batch is worth, then how many batches — a ratio grows by copies, not by steps."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
      "I know because ___ ."
  ...
  "3-3-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Scaled a ratio by adding instead of multiplying” error fails in every case, not just this one.",
      "ifStuck": "Give them a 1-to-something row on the ratio table and ask what one step of scaling does.",
      "extend": "Ask them to write a ratio that is NOT equivalent, and justify why it fails."
    },
    "listenFor": [
      "A strong answer says BOTH quantities are multiplied by the same number (4), so 2:3 becomes 8:12, keeping the ratio equivalent.",
  ...
  "3-4-group2": {
    ...
    "teacherMoves": {
      "ask": "Why does adding to both parts break a ratio when adding to both sides keeps an equation true?",
      "lookFor": "A student who can explain why the “Scaled a ratio by adding instead of multiplying” error fails in every case, not just this one.",
      "ifStuck": "Give them a 1-to-something row on the tape diagram and ask what one step of scaling does.",
      "extend": "Ask them to write a ratio that is NOT equivalent, and justify why it fails."
    },
    "listenFor": [
      "A strong answer chooses sundaes (x) and ounces of sauce (y), and predicts a straight line because each sundae always needs 2 more ounces.",
  ...
  "4-5-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Multiplied when the problem divides” error fails in every case, not just this one.",
  ...
  "5-10-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students added the dimensions instead of multiplying — that is this lesson's error.",
  ...
  "5-10-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Added the dimensions instead of multiplying” error fails in every case, not just this one.",
      "ifStuck": "Ask how many unit cubes fit along each edge of the cross-section, then what to do with the three numbers.",
      "extend": "Ask for two different shapes with the same answer — what stayed constant?"
    },
    "listenFor": [
      "Students explain the formula stays the same (V = l × w × h = 2 × 1.5 × 1 = 3 ft³) and that a fractional edge just means multiplying with a fraction or decimal.",
  ...
  "5-2-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Found base × height but forgot the half” error fails in every case, not just this one.",
  ...
  "5-4-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Swapped area and perimeter” error fails in every case, not just this one.",
  ...
  "5-6-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students found the volume instead of the surface area — that is this lesson's error.",
      "ifStuck": "Ask what the unit has to be — square units cover a surface, cubic units fill a space."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
      "I know because ___ ."
  ...
  "5-6-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Found the volume instead of the surface area” error fails in every case, not just this one.",
  ...
  "6-13-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students a common mistake in Prime Factorization is stopping the factor tree too soon — leaving a composite number like 4, 6, 8, or 9 in the final answer instead of continuing to split it. For example, writing 20 = 4 × 5 as the prime factorization (4 is composite) instead of finishing with 20 = 2 × 2 × 5. Before you submit, check every number in your final answer: if any factor can still be broken into smaller factors, the tree isn't finished yet.",
      "ifStuck": "Go back to the factor tree and rebuild the first step together before releasing them."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
      "I know because ___ ."
  ...
  "6-14-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Distributed to the first term only” error fails in every case, not just this one.",
  ...
  "6-15-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Multiplied when the problem adds” error fails in every case, not just this one.",
  ...
  "6-2-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Divided fractions without inverting” error fails in every case, not just this one.",
  ...
  "6-3-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students worked left to right instead of by operation order — that is this lesson's error.",
  ...
  "6-3-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Worked left to right instead of by operation order” error fails in every case, not just this one.",
  ...
  "7-1-group1": {
    ...
    "who": "Pull 3–5 students who struggled on the formative check / exit ticket for this lesson.",
    "teacherMoves": {
      "ask": "Where does that number sit on the number line, and which side of zero?",
      "lookFor": "Students the most common mistake in this lesson is thinking that the opposite of a negative integer is still negative — for example, saying the opposite of -7 is -7, or that the opposite of -12 is -24. Opposites are the same DISTANCE from 0 but on OPPOSITE sides of 0, so taking an opposite always changes the direction and never changes the distance: the opposite of -7 is 7 and the opposite of -12 is 12. The one exception is 0, which is 0 units from itself and is therefore its own opposite. Before you submit, count the units from 0 and check that your answer is on the other side.",
      "ifStuck": "Go back to the number line and rebuild the first step together before releasing them."
    },
    "frames": [
      "The multiples/steps I need are ___ , and the answer is ___ .",
  ...
  "7-5-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Swapped the x and y coordinates” error fails in every case, not just this one.",
      "ifStuck": "Ask them to plot both (a, b) and (b, a) on the coordinate plane and describe the line between them.",
      "extend": "Ask when a negative answer is larger than a positive one, and why."
    },
    "listenFor": [
      "Student states the x-coordinate is the sideways (horizontal) move and the y-coordinate is the up/down (vertical) move, both starting from the origin.",
  ...
  "8-2-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students answered with a number already in the equation — that is this lesson's error.",
  ...
  "8-2-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Answered with a number already in the equation” error fails in every case, not just this one.",
      "ifStuck": "Ask them to check a wrong answer by substitution and say what it proves.",
      "extend": "Ask them to build an equation with no solution, then one true for every value."
    },
    "listenFor": [
  ...
  "8-3-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Did not undo the operation” error fails in every case, not just this one.",
  ...
  "8-4-group1": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "Students boundary value wrongly included or excluded — that is this lesson's error.",
  ...
  "8-4-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Boundary value wrongly included or excluded” error fails in every case, not just this one.",
      "ifStuck": "Ask them to check a wrong answer by substitution and say what it proves.",
      "extend": "Ask them to build an equation with no solution, then one true for every value."
    },
    "listenFor": [
  ...
  "8-5-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Graph shaded toward the wrong side” error fails in every case, not just this one.",
      "ifStuck": "Ask them to check a wrong answer by substitution and say what it proves.",
      "extend": "Ask them to build an equation with no solution, then one true for every value."
    },
    "listenFor": [
  ...
  "8-6-group2": {
    ...
    "teacherMoves": {
      ...
      "lookFor": "A student who can explain why the “Right boundary, symbol reversed” error fails in every case, not just this one.",
