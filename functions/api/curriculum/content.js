    ...
    },
    {
      ...
      lessons: [
        ...
        },
        {
          id: "3-5",
          num: "Lesson 3.5",
          title: "Comparing Ratios & Rates",
          std: "6.RP.A.2",
          obj: "Understand unit rate a/b associated with ratio a:b.",
          resources: [{ text: "Interactive Activity", href: "/lessons/3-5/", type: "activity" }],
        },
        {
          id: "3-6",
          num: "Lesson 3.6",
          title: "Ratio Reasoning Choice Board",
          std: "6.RP.A.3",
          obj: "Apply multiple ratio representations to solve complex scenarios.",
          resources: [{ text: "Interactive Activity", href: "/lessons/3-6/", type: "activity" }],
        },
        {
          id: "3-7",
          num: "Lesson 3.7",
          title: "Ratio Problem-Solving Case File",
          std: "6.RP.A.3",
          obj: "Solve real-world ratio case files using tables and tape diagrams.",
          resources: [{ text: "Interactive Activity", href: "/lessons/3-7/", type: "activity" }],
        },
      ],
    },
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          std: "6.RP.A.3.C",
          obj: "Find a percent of a quantity as a rate per 100.",
          resources: [{ text: "Interactive Activity", href: "/lessons/4-2/", type: "activity" }],
        },
        {
          id: "4-3",
          num: "Lesson 4.3",
        ...
        },
        {
          ...
          std: "6.RP.A.3.C",
          obj: "Solve problems finding the percent of a whole quantity.",
          resources: [{ text: "Interactive Activity", href: "/lessons/4-4/", type: "activity" }],
        },
        {
          id: "4-5",
          num: "Lesson 4.5",
          title: "Finding the Whole Given a Percent",
          std: "6.RP.A.3.C",
          obj: "Determine the total whole given a part and its percentage.",
          resources: [{ text: "Interactive Activity", href: "/lessons/4-5/", type: "activity" }],
        },
        {
          id: "4-6",
          num: "Lesson 4.6",
      ...
      lessons: [
        {
          ...
          std: "6.EE.A.1",
          obj: "Write and evaluate numerical expressions involving whole-number exponents.",
          resources: [{ text: "Interactive Activity", href: "/lessons/5-1/", type: "activity" }],
        },
        {
          id: "5-2",
          num: "Lesson 5.2",
    ...
    },
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          std: "6.EE.C.9",
          obj: "Represent and analyze quantitative relationships between variables.",
          resources: [{ text: "Interactive Activity", href: "/lessons/6-6/", type: "activity" }],
        },
        {
          id: "6-7",
          num: "Lesson 6.7",
