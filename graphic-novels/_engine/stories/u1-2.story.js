/* STORY · Unit 1 · Graphic Novel #2 (Enrichment) · Prime Station: The Factor Code
   ...
   carried verbatim from graphic-novels/unit1/graphic-novel-2.html (6.NOS.4).
    ...
    /* ============================ ACT 1 ============================ */
    {
      ...
      steps: [
        ...
        },
        {
          ...
          ask: {
            who: "cadet",
            en: "To open the bay, which factor tree for <b>120</b> is <b>fully reduced</b> — every leaf a prime?",
          },
          choices: [
            {
              en: "A) 120 = 2³ × 3 × 5",
    ...
    /* ============================ FINAL ============================ */
    {
      ...
      steps: [
        ...
        },
        {
          ...
          ask: {
            who: "cadet",
            en: "Careful, AXIS — check the shared primes again. What is the prime factorization of <b>84</b> in exponent form, and what is the <b>GCF of 84 and 126</b>? Pick the line where both are correct.",
          },
          choices: [
            {
