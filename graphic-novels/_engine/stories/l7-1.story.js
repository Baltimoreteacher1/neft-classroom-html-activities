          ...
          beats: [
            ...
            },
            {
              ...
              vocab: [
                {
                  term: "divisor",
                  en: "The number of equal groups you are dividing into (the number outside the division bracket).",
                  es: "El número de partes iguales en las que divides (el número fuera de la casilla de división).",
                },
              ],
            },
            {
