...
const SYNONYMS = {
  // ── Reveal Session 1/2 vocabulary (2026-09-20) ──────────────────────────
  // Terms the district practice sheets teach that the configs did not list.
  // Each is mapped to the tile that already draws what the word MEANS; a new
  // drawing is only warranted where no existing tile means the word.
  "frequency-table": "frequency",
  "shape-of-the-data": "distribution",
  peak: "mode",
  "halfway-value": "median",
  "five-number-summary": "box-plot",
  whisker: "box-plot",
  "middle-half": "interquartile-range",
  "extreme-value": "range",
  resistant: "median",
  "annex-a-zero": "decimal-division-algorithm",
  "power-of-ten": "place-value",
  "target-mean": "mean",
  "target-total": "sum",
  variation: "spread",
  "simplest-form": "equivalent-ratio",
  "total-parts": "bar-model",
  "total-price": "unit-rate",
  "unit-rate-point": "unit-rate",
  interpret: "ordered-pair",
  "multi-step-problem": "strategy",
  dose: "rate",
  "common-form": "percent",
  "equivalent-fraction": "equivalent-ratio",
  diagonal: "rhombus",
  "right-triangle": "triangle",
  "right-trapezoid": "trapezoid",
  congruent: "regular-polygon",
  "unit-cube": "cubic-units",
  "multiplicative-inverse": "reciprocal",
  "repeated-multiplication": "exponent",
  "expanded-form": "exponent",
  squared: "exponent",
  cubed: "exponent",
  "grouping-symbols": "expression",
  "equivalent-expressions": "distributive-property",
  "factor-an-expression": "distributive-property",
  "opposite-of-the-opposite": "opposite",
  magnitude: "absolute-value",
  "x-coordinate": "ordered-pair",
  "side-length": "segment",
  "subtraction-property-of-equality": "equation",
  "addition-property-of-equality": "equation",
  "division-property-of-equality": "equation",
  "multiplication-property-of-equality": "equation",
  "true-statement": "inequality",
