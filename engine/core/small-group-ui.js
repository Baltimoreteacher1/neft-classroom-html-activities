...
export function injectSmallGroupStyles(accent) {
  ...
  if (!document.getElementById("sg-innovation-styles")) {
    ...
    innovation.href = "/assets/small-group-innovation.css?v=20260718-guide3";
  ...
  styles.textContent = `
    ...
    *{box-sizing:border-box}
    ...
    @keyframes sg-panelin{from{transform:translateY(8px)}to{transform:none}}.sg-next{display:flex;justify-content:flex-end;margin:24px 0 8px;padding-top:20px;border-top:1px solid var(--sg-line)}
