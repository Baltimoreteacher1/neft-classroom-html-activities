...
export function injectSmallGroupStyles(accent) {
  ...
  if (!document.getElementById("sg-innovation-styles")) {
    ...
    innovation.href = "/assets/small-group-innovation.css?v=20260729-misconception1";
  ...
  styles.textContent = `
    ...
    *{box-sizing:border-box}
    ...
    .sg-teacher details{border:2px dashed var(--sg);border-radius:14px;background:var(--sg-card)}
    .sg-teacher summary{cursor:pointer;padding:13px 16px;font-family:"Nunito",sans-serif;font-weight:900;color:var(--sg-ink)}
    .sg-tbody{padding:0 18px 18px}.sg-tbody li{margin:5px 0}.sg-frames,.sg-wordbank{display:flex;flex-wrap:wrap;gap:8px}
    .sg-frame,.sg-word{padding:7px 11px;border-radius:9px;background:var(--sg-soft);color:var(--sg-ink);font-weight:700}
    ...
    .sg-mode--teacher{background:#58320a}.sg-mode-notice{margin:12px 0;padding:11px 14px;border:1px solid var(--sg-warn-line);border-radius:11px;color:var(--sg-warn-ink);background:var(--sg-warn-bg)}
    ...
    .sg-step .dot{display:grid;width:25px;height:25px;flex:none;place-items:center;border-radius:8px;background:var(--sg-fill)}
    .sg-step.done{color:var(--sg-ink);background:var(--sg-card)}.sg-step.done .dot{color:#fff;background:var(--sg)}
    .sg-step[aria-selected="true"]{color:#fff;background:var(--sg)}.sg-step[aria-selected="true"] .dot{color:var(--sg-ink);background:var(--sg-pop)}
    ...
    .sg-mission-visual.no-image{display:grid;place-items:center;padding:22px;color:var(--sg-ink);font-family:"Nunito",sans-serif;font-size:70px}
    ...
    .btn:hover:not(:disabled){transform:translateY(-1px)}.btn:active:not(:disabled){transform:translateY(1px) scale(.98)}.btn.ghost{color:var(--sg-ink);background:var(--sg-card)}.btn:disabled{opacity:.55;cursor:default}
    .sg-pulse-btn,.sg-role-btn,.sg-match-btn{padding:9px 13px;border:2px solid var(--sg-line);color:var(--sg-text);background:var(--sg-card);font-weight:700;text-align:left}
    ...
    .keyidea{margin:18px 0 8px;padding:16px 18px;border-left:6px solid var(--sg);border-radius:12px;background:var(--sg-soft);color:var(--sg-ink);font-size:20px;line-height:1.5;font-weight:700}
    ...
    .sg-problem-nav{display:grid;grid-template-columns:1fr auto 1fr;gap:10px;align-items:center;margin:14px 0 24px}.sg-problem-nav .btn:last-child{justify-self:end}.sg-problem-count{color:var(--sg-ink);font-family:"Nunito",sans-serif;font-weight:900;text-align:center}.mistake summary{cursor:pointer;font-weight:900}.mistake p{margin:9px 0 0}
    .sg-problem-support-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:18px 0 8px}.sg-visual-title{color:var(--sg-ink);font-family:"Nunito",sans-serif;font-size:20px;font-weight:900}.sg-read-problem{min-height:44px;padding:8px 12px}.sg-problem-visual{overflow:hidden;margin:0 0 12px;border:3px solid var(--sg);border-radius:20px;background:var(--sg-figure);box-shadow:0 10px 25px rgba(23,32,51,.09)}.sg-problem-visual svg{display:block;width:100%;min-height:250px;height:auto}.sg-problem-visual svg text{fill:var(--sg-ink);font-family:"Nunito",sans-serif;font-size:22px;font-weight:900}.sg-problem-visual .sg-layer-2,.sg-problem-visual .sg-layer-3{opacity:.12;transition:opacity .2s}.prob.sg-show-layer-2 .sg-layer-2,.prob.sg-show-layer-3 .sg-layer-2,.prob.sg-show-layer-3 .sg-layer-3{opacity:1}
    ...
    .sg-problem-model svg text{fill:var(--sg-ink);font-family:"Nunito",sans-serif;font-size:22px;font-weight:900}
    .sg-model-title{margin-bottom:4px;color:var(--sg-ink);font-family:"Nunito",sans-serif;font-size:19px;font-weight:900}
    ...
    .sg-model-rowlab{color:var(--sg-ink);font-family:"Nunito",sans-serif;font-weight:900}
    ...
    .sg-tree-level+.sg-tree-level::before{content:"↳ split the composite factor";position:absolute;top:-4px;left:50%;transform:translateX(-50%);font:800 12px/1 "Nunito",sans-serif;color:var(--sg-ink);opacity:.7;white-space:nowrap}
    .sg-tree-level.locked{opacity:.45;filter:grayscale(.3)}
    .sg-tree-node{display:grid;min-width:64px;height:56px;padding:0 10px;place-items:center;border-radius:16px;background:var(--sg-soft);color:var(--sg-ink);font-family:"Nunito",sans-serif;font-size:22px;font-weight:900}
    ...
    .sg-div-bracket{text-align:center;color:var(--sg-ink);font-family:"Nunito",ui-monospace,monospace;font-size:38px;font-weight:900;border-top:4px solid var(--sg-rule);width:max-content;margin:2px auto 8px;padding:2px 14px}
    ...
    .sg-tile{min-width:44px;min-height:52px;border-radius:10px;font-family:"Nunito",sans-serif;font-size:20px;font-weight:900;cursor:pointer;border:2px solid var(--sg-rule)}
    ...
    .eqcap{margin-bottom:7px;color:var(--sg-ink);font-family:"Nunito",sans-serif;font-size:19px;font-weight:900}.colmath{display:inline-grid;min-width:160px;justify-items:end;gap:2px;padding:11px 18px;border-radius:13px;background:var(--sg-soft);font-family:"Nunito",ui-monospace,monospace;font-size:27px;font-weight:900}.col-op{margin-right:15px;color:var(--sg)}.col-rule{width:100%;height:3px;margin:3px 0;background:var(--sg-rule)}
    ...
    .sg-datachips-title{margin-bottom:9px;font-family:"Nunito",sans-serif;font-weight:900;color:var(--sg-ink)}
    ...
    .sg-cloze{margin-top:14px;padding:18px;border:2px dashed var(--sg);border-radius:16px;background:var(--sg-card)}
    ...
    .sg-path b{font-family:"Nunito",sans-serif;color:var(--sg-ink)}
    ...
    .sg-streak{display:inline-flex;align-items:center;gap:4px;padding:3px 9px;border:1px solid var(--sg-warn-line);border-radius:999px;background:var(--sg-warn-bg);color:var(--sg-warn-ink);font-family:"Nunito",sans-serif;font-size:12px;font-weight:900;white-space:nowrap;animation:sg-stepin .3s ease}
