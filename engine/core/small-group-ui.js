...
export function injectSmallGroupStyles(accent) {
  ...
  styles.textContent = `
    ...
    *{box-sizing:border-box}
    ...
    .sg-mode-action{min-height:38px;padding:7px 12px;border:1px solid rgba(255,255,255,.5);border-radius:9px;color:#fff;text-decoration:none}
    ...
    .sg-vcard{position:relative;min-height:180px;padding:17px;border:1px solid var(--sg-line);border-radius:16px;background:#fff;box-shadow:0 5px 16px rgba(23,32,51,.05)}.sg-vcard-picture{display:grid;min-height:150px;margin:-5px -5px 14px;place-items:center;overflow:hidden;border-radius:13px;background:var(--sg-soft)}.sg-vcard-picture img{display:block;width:100%;max-height:190px;object-fit:contain}
    ...
    .sg-directions{margin:-3px 0 14px;padding:11px 14px;border-left:5px solid var(--sg);border-radius:10px;background:var(--sg-soft);color:var(--sg-deep);font-weight:700}.prob{padding:18px;margin-bottom:14px}.q{display:flex;gap:10px;margin:0 0 14px;font-size:17px;font-weight:700}.pn{display:grid;width:29px;height:29px;flex:none;place-items:center;border-radius:9px;color:#fff;background:var(--sg);font-weight:900}
    ...
    .sg-apply-step.locked{display:none}
    ...
    .sg-speak-inline{margin-left:7px;border:1px solid var(--sg-line);border-radius:50%;width:30px;height:30px;background:#fff;cursor:pointer;font-size:13px}
    /* ── Vocabulary languages + cloze ── */
    .sg-langbar{display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin-bottom:12px}
    .sg-langbtn{min-height:38px;padding:6px 12px;border:2px solid var(--sg-line);border-radius:999px;background:#fff;font-weight:800;cursor:pointer}
    ...
    .sg-vexample{padding:5px 10px;border-radius:8px;background:#f1f4f8;color:var(--sg-text);font-size:14px;font-weight:600}
