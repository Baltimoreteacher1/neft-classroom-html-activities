...
// A sync code is the only thing protecting a blob. Short, memorable codes are
// allowed by request (Noam picks his own) — any non-empty code works; the
// trade-off is that a very short code is easier to guess.
